...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.systemToolsBuiltinDesc":
      "XAgent 在 Agent 模式下自动注册的内置工具，此处仅供查阅。",
    ...
    "settings.remoteDesc": "通过云端 Gateway 远程控制本地 XAgent",
    ...
    "settings.remoteInfoBanner":
      "启用后，本地 XAgent 将通过 WebSocket（v2 协议）连接云端 Gateway。你可以在浏览器中通过 WebUI 远程发送 Chat 消息、管理 Cron 任务和查看历史记录。所有工具执行仍在本地完成，远程端仅转发指令和结果。",
  ...
  "en-US": {
    ...
    "settings.remoteDesc": "Control your local XAgent remotely via cloud Gateway",
    ...
    "settings.remoteInfoBanner":
      "When enabled, the local XAgent connects to the cloud Gateway over WebSocket (protocol v2). You can remotely send Chat messages, manage Cron tasks, and view history through the WebUI in your browser. All tool execution remains local — the remote end only relays commands and results.",
