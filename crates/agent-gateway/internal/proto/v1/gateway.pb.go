...
type TunnelFrame struct {
	...
	Kind          TunnelFrameKind        `protobuf:"varint,2,opt,name=kind,proto3,enum=xagent.gateway.v1.TunnelFrameKind" json:"kind,omitempty"`
	...
	WsMessageType TunnelWsMessageType    `protobuf:"varint,10,opt,name=ws_message_type,json=wsMessageType,proto3,enum=xagent.gateway.v1.TunnelWsMessageType" json:"ws_message_type,omitempty"`
...
type ManagedProcessRecord struct {
	...
	Isolated      bool                   `protobuf:"varint,12,opt,name=isolated,proto3" json:"isolated,omitempty"` // survives XAgent exit
...
type ChatEvent struct {
	state          protoimpl.MessageState  `protogen:"open.v1"`
	Type           ChatEvent_ChatEventType `protobuf:"varint,1,opt,name=type,proto3,enum=xagent.gateway.v1.ChatEvent_ChatEventType" json:"type,omitempty"`
	ConversationId string                  `protobuf:"bytes,2,opt,name=conversation_id,json=conversationId,proto3" json:"conversation_id,omitempty"`
...
var file_proto_v1_gateway_proto_goTypes = []any{
	(TunnelFrameKind)(0),                      // 0: xagent.gateway.v1.TunnelFrameKind
	(TunnelWsMessageType)(0),                  // 1: xagent.gateway.v1.TunnelWsMessageType
	(ChatEvent_ChatEventType)(0),              // 2: xagent.gateway.v1.ChatEvent.ChatEventType
	(*AuthRequest)(nil),                       // 3: xagent.gateway.v1.AuthRequest
	(*AuthResponse)(nil),                      // 4: xagent.gateway.v1.AuthResponse
	(*GatewayEnvelope)(nil),                   // 5: xagent.gateway.v1.GatewayEnvelope
	(*AgentEnvelope)(nil),                     // 6: xagent.gateway.v1.AgentEnvelope
	(*ChatSelectedModel)(nil),                 // 7: xagent.gateway.v1.ChatSelectedModel
	(*ChatRuntimeControls)(nil),               // 8: xagent.gateway.v1.ChatRuntimeControls
	(*ChatUploadedFile)(nil),                  // 9: xagent.gateway.v1.ChatUploadedFile
	(*UploadReadableFile)(nil),                // 10: xagent.gateway.v1.UploadReadableFile
	(*UploadReadableFilesRequest)(nil),        // 11: xagent.gateway.v1.UploadReadableFilesRequest
	(*UploadReadableFilesResponse)(nil),       // 12: xagent.gateway.v1.UploadReadableFilesResponse
	(*UploadedImagePreviewRequest)(nil),       // 13: xagent.gateway.v1.UploadedImagePreviewRequest
	(*UploadedImagePreviewResponse)(nil),      // 14: xagent.gateway.v1.UploadedImagePreviewResponse
	(*TunnelSpec)(nil),                        // 15: xagent.gateway.v1.TunnelSpec
	(*TunnelDesiredState)(nil),                // 16: xagent.gateway.v1.TunnelDesiredState
	(*TunnelHealth)(nil),                      // 17: xagent.gateway.v1.TunnelHealth
	(*TunnelStatus)(nil),                      // 18: xagent.gateway.v1.TunnelStatus
	(*TunnelStateSnapshot)(nil),               // 19: xagent.gateway.v1.TunnelStateSnapshot
	(*TunnelMutation)(nil),                    // 20: xagent.gateway.v1.TunnelMutation
	(*TunnelMutationResult)(nil),              // 21: xagent.gateway.v1.TunnelMutationResult
	(*TunnelProbeResult)(nil),                 // 22: xagent.gateway.v1.TunnelProbeResult
	(*TunnelProbeReport)(nil),                 // 23: xagent.gateway.v1.TunnelProbeReport
	(*TunnelHeader)(nil),                      // 24: xagent.gateway.v1.TunnelHeader
	(*TunnelFrame)(nil),                       // 25: xagent.gateway.v1.TunnelFrame
	(*WorkspaceWatchRequest)(nil),             // 26: xagent.gateway.v1.WorkspaceWatchRequest
	(*WorkspaceActivityEvent)(nil),            // 27: xagent.gateway.v1.WorkspaceActivityEvent
	(*ManagedProcessRecord)(nil),              // 28: xagent.gateway.v1.ManagedProcessRecord
	(*ManagedProcessSnapshot)(nil),            // 29: xagent.gateway.v1.ManagedProcessSnapshot
	(*ManagedProcessRequest)(nil),             // 30: xagent.gateway.v1.ManagedProcessRequest
	(*ManagedProcessResponse)(nil),            // 31: xagent.gateway.v1.ManagedProcessResponse
	(*MemoryManageRequest)(nil),               // 32: xagent.gateway.v1.MemoryManageRequest
	(*MemoryManageResponse)(nil),              // 33: xagent.gateway.v1.MemoryManageResponse
	(*TerminalRequest)(nil),                   // 34: xagent.gateway.v1.TerminalRequest
	(*TerminalSession)(nil),                   // 35: xagent.gateway.v1.TerminalSession
	(*TerminalSshMetadata)(nil),               // 36: xagent.gateway.v1.TerminalSshMetadata
	(*SftpRequest)(nil),                       // 37: xagent.gateway.v1.SftpRequest
	(*SftpEntry)(nil),                         // 38: xagent.gateway.v1.SftpEntry
	(*SftpTransfer)(nil),                      // 39: xagent.gateway.v1.SftpTransfer
	(*SftpResponse)(nil),                      // 40: xagent.gateway.v1.SftpResponse
	(*SftpEvent)(nil),                         // 41: xagent.gateway.v1.SftpEvent
	(*TerminalSshPrompt)(nil),                 // 42: xagent.gateway.v1.TerminalSshPrompt
	(*TerminalShellOption)(nil),               // 43: xagent.gateway.v1.TerminalShellOption
	(*TerminalSshTab)(nil),                    // 44: xagent.gateway.v1.TerminalSshTab
	(*TerminalSshTabsSnapshot)(nil),           // 45: xagent.gateway.v1.TerminalSshTabsSnapshot
	(*TerminalResponse)(nil),                  // 46: xagent.gateway.v1.TerminalResponse
	(*TerminalEvent)(nil),                     // 47: xagent.gateway.v1.TerminalEvent
	(*TerminalStreamFrame)(nil),               // 48: xagent.gateway.v1.TerminalStreamFrame
	(*GitRequest)(nil),                        // 49: xagent.gateway.v1.GitRequest
	(*GitResponse)(nil),                       // 50: xagent.gateway.v1.GitResponse
	(*ChatRequest)(nil),                       // 51: xagent.gateway.v1.ChatRequest
	(*ChatMessageRef)(nil),                    // 52: xagent.gateway.v1.ChatMessageRef
	(*CancelChatRequest)(nil),                 // 53: xagent.gateway.v1.CancelChatRequest
	(*ChatCommandRequest)(nil),                // 54: xagent.gateway.v1.ChatCommandRequest
	(*ChatQueueRequest)(nil),                  // 55: xagent.gateway.v1.ChatQueueRequest
	(*ChatQueueResponse)(nil),                 // 56: xagent.gateway.v1.ChatQueueResponse
	(*ChatQueueEvent)(nil),                    // 57: xagent.gateway.v1.ChatQueueEvent
	(*ChatEvent)(nil),                         // 58: xagent.gateway.v1.ChatEvent
	(*ChatControlEvent)(nil),                  // 59: xagent.gateway.v1.ChatControlEvent
	(*ChatRuntimeSnapshot)(nil),               // 60: xagent.gateway.v1.ChatRuntimeSnapshot
	(*RuntimeStatusEvent)(nil),                // 61: xagent.gateway.v1.RuntimeStatusEvent
	(*ChatRunReport)(nil),                     // 62: xagent.gateway.v1.ChatRunReport
	(*CronManageRequest)(nil),                 // 63: xagent.gateway.v1.CronManageRequest
	(*CronManageResponse)(nil),                // 64: xagent.gateway.v1.CronManageResponse
	(*HistoryListRequest)(nil),                // 65: xagent.gateway.v1.HistoryListRequest
	(*HistoryListResponse)(nil),               // 66: xagent.gateway.v1.HistoryListResponse
	(*ConversationSummary)(nil),               // 67: xagent.gateway.v1.ConversationSummary
	(*HistoryGetRequest)(nil),                 // 68: xagent.gateway.v1.HistoryGetRequest
	(*HistoryGetResponse)(nil),                // 69: xagent.gateway.v1.HistoryGetResponse
	(*HistoryPrefixRequest)(nil),              // 70: xagent.gateway.v1.HistoryPrefixRequest
	(*HistoryPrefixResponse)(nil),             // 71: xagent.gateway.v1.HistoryPrefixResponse
	(*HistoryRenameRequest)(nil),              // 72: xagent.gateway.v1.HistoryRenameRequest
	(*HistoryRenameResponse)(nil),             // 73: xagent.gateway.v1.HistoryRenameResponse
	(*HistoryBranchRequest)(nil),              // 74: xagent.gateway.v1.HistoryBranchRequest
	(*HistoryBranchResponse)(nil),             // 75: xagent.gateway.v1.HistoryBranchResponse
	(*HistoryPinRequest)(nil),                 // 76: xagent.gateway.v1.HistoryPinRequest
	(*HistoryPinResponse)(nil),                // 77: xagent.gateway.v1.HistoryPinResponse
	(*HistoryShareStatus)(nil),                // 78: xagent.gateway.v1.HistoryShareStatus
	(*HistoryShareGetRequest)(nil),            // 79: xagent.gateway.v1.HistoryShareGetRequest
	(*HistoryShareGetResponse)(nil),           // 80: xagent.gateway.v1.HistoryShareGetResponse
	(*HistoryShareSetRequest)(nil),            // 81: xagent.gateway.v1.HistoryShareSetRequest
	(*HistoryShareSetResponse)(nil),           // 82: xagent.gateway.v1.HistoryShareSetResponse
	(*HistoryShareResolveRequest)(nil),        // 83: xagent.gateway.v1.HistoryShareResolveRequest
	(*HistoryShareResolveResponse)(nil),       // 84: xagent.gateway.v1.HistoryShareResolveResponse
	(*HistoryWorkdirsRequest)(nil),            // 85: xagent.gateway.v1.HistoryWorkdirsRequest
	(*HistoryWorkdirSummary)(nil),             // 86: xagent.gateway.v1.HistoryWorkdirSummary
	(*HistoryWorkdirsResponse)(nil),           // 87: xagent.gateway.v1.HistoryWorkdirsResponse
	(*HistoryDeleteRequest)(nil),              // 88: xagent.gateway.v1.HistoryDeleteRequest
	(*HistoryDeleteResponse)(nil),             // 89: xagent.gateway.v1.HistoryDeleteResponse
	(*HistorySyncEvent)(nil),                  // 90: xagent.gateway.v1.HistorySyncEvent
	(*ProviderListRequest)(nil),               // 91: xagent.gateway.v1.ProviderListRequest
	(*ProviderListResponse)(nil),              // 92: xagent.gateway.v1.ProviderListResponse
	(*SettingsGetRequest)(nil),                // 93: xagent.gateway.v1.SettingsGetRequest
	(*SettingsGetResponse)(nil),               // 94: xagent.gateway.v1.SettingsGetResponse
	(*SettingsUpdateRequest)(nil),             // 95: xagent.gateway.v1.SettingsUpdateRequest
	(*SettingsUpdateResponse)(nil),            // 96: xagent.gateway.v1.SettingsUpdateResponse
	(*SettingsResetSshKnownHostRequest)(nil),  // 97: xagent.gateway.v1.SettingsResetSshKnownHostRequest
	(*SettingsResetSshKnownHostResponse)(nil), // 98: xagent.gateway.v1.SettingsResetSshKnownHostResponse
	(*SettingsSyncEvent)(nil),                 // 99: xagent.gateway.v1.SettingsSyncEvent
	(*SkillFilesListRequest)(nil),             // 100: xagent.gateway.v1.SkillFilesListRequest
	(*SkillFilesListResponse)(nil),            // 101: xagent.gateway.v1.SkillFilesListResponse
	(*SkillMetadataReadRequest)(nil),          // 102: xagent.gateway.v1.SkillMetadataReadRequest
	(*SkillMetadataReadResponse)(nil),         // 103: xagent.gateway.v1.SkillMetadataReadResponse
	(*SkillTextReadRequest)(nil),              // 104: xagent.gateway.v1.SkillTextReadRequest
	(*SkillTextReadResponse)(nil),             // 105: xagent.gateway.v1.SkillTextReadResponse
	(*SkillManageRequest)(nil),                // 106: xagent.gateway.v1.SkillManageRequest
	(*SkillManageResponse)(nil),               // 107: xagent.gateway.v1.SkillManageResponse
	(*FileMentionListRequest)(nil),            // 108: xagent.gateway.v1.FileMentionListRequest
	(*FileMentionEntry)(nil),                  // 109: xagent.gateway.v1.FileMentionEntry
	(*FileMentionListResponse)(nil),           // 110: xagent.gateway.v1.FileMentionListResponse
	(*FsRoot)(nil),                            // 111: xagent.gateway.v1.FsRoot
	(*FsRootsRequest)(nil),                    // 112: xagent.gateway.v1.FsRootsRequest
	(*FsRootsResponse)(nil),                   // 113: xagent.gateway.v1.FsRootsResponse
	(*FsListDirsRequest)(nil),                 // 114: xagent.gateway.v1.FsListDirsRequest
	(*FsDirEntry)(nil),                        // 115: xagent.gateway.v1.FsDirEntry
	(*FsListDirsResponse)(nil),                // 116: xagent.gateway.v1.FsListDirsResponse
	(*FsCreateProjectFolderRequest)(nil),      // 117: xagent.gateway.v1.FsCreateProjectFolderRequest
	(*FsCreateProjectFolderResponse)(nil),     // 118: xagent.gateway.v1.FsCreateProjectFolderResponse
	(*FsListRequest)(nil),                     // 119: xagent.gateway.v1.FsListRequest
	(*FsListEntry)(nil),                       // 120: xagent.gateway.v1.FsListEntry
	(*FsListResponse)(nil),                    // 121: xagent.gateway.v1.FsListResponse
	(*FsReadEditableTextRequest)(nil),         // 122: xagent.gateway.v1.FsReadEditableTextRequest
	(*FsReadEditableTextResponse)(nil),        // 123: xagent.gateway.v1.FsReadEditableTextResponse
	(*FsReadWorkspaceImageRequest)(nil),       // 124: xagent.gateway.v1.FsReadWorkspaceImageRequest
	(*FsReadWorkspaceImageResponse)(nil),      // 125: xagent.gateway.v1.FsReadWorkspaceImageResponse
	(*FsWriteTextRequest)(nil),                // 126: xagent.gateway.v1.FsWriteTextRequest
	(*FsWriteTextResponse)(nil),               // 127: xagent.gateway.v1.FsWriteTextResponse
	(*FsCreateDirRequest)(nil),                // 128: xagent.gateway.v1.FsCreateDirRequest
	(*FsCreateDirResponse)(nil),               // 129: xagent.gateway.v1.FsCreateDirResponse
	(*FsRenameRequest)(nil),                   // 130: xagent.gateway.v1.FsRenameRequest
	(*FsRenameResponse)(nil),                  // 131: xagent.gateway.v1.FsRenameResponse
	(*FsDeleteRequest)(nil),                   // 132: xagent.gateway.v1.FsDeleteRequest
	(*FsDeleteResponse)(nil),                  // 133: xagent.gateway.v1.FsDeleteResponse
	(*PingRequest)(nil),                       // 134: xagent.gateway.v1.PingRequest
	(*PongResponse)(nil),                      // 135: xagent.gateway.v1.PongResponse
	(*ErrorResponse)(nil),                     // 136: xagent.gateway.v1.ErrorResponse
	(*ProviderModelsRequest)(nil),             // 137: xagent.gateway.v1.ProviderModelsRequest
	(*ProviderModelsResponse)(nil),            // 138: xagent.gateway.v1.ProviderModelsResponse
}
var file_proto_v1_gateway_proto_depIdxs = []int32{
	54,  // 0: xagent.gateway.v1.GatewayEnvelope.chat_command:type_name -> xagent.gateway.v1.ChatCommandRequest
	63,  // 1: xagent.gateway.v1.GatewayEnvelope.cron_manage:type_name -> xagent.gateway.v1.CronManageRequest
	65,  // 2: xagent.gateway.v1.GatewayEnvelope.history_list:type_name -> xagent.gateway.v1.HistoryListRequest
	68,  // 3: xagent.gateway.v1.GatewayEnvelope.history_get:type_name -> xagent.gateway.v1.HistoryGetRequest
	72,  // 4: xagent.gateway.v1.GatewayEnvelope.history_rename:type_name -> xagent.gateway.v1.HistoryRenameRequest
	88,  // 5: xagent.gateway.v1.GatewayEnvelope.history_delete:type_name -> xagent.gateway.v1.HistoryDeleteRequest
	70,  // 6: xagent.gateway.v1.GatewayEnvelope.history_prefix:type_name -> xagent.gateway.v1.HistoryPrefixRequest
	76,  // 7: xagent.gateway.v1.GatewayEnvelope.history_pin:type_name -> xagent.gateway.v1.HistoryPinRequest
	79,  // 8: xagent.gateway.v1.GatewayEnvelope.history_share_get:type_name -> xagent.gateway.v1.HistoryShareGetRequest
	81,  // 9: xagent.gateway.v1.GatewayEnvelope.history_share_set:type_name -> xagent.gateway.v1.HistoryShareSetRequest
	83,  // 10: xagent.gateway.v1.GatewayEnvelope.history_share_resolve:type_name -> xagent.gateway.v1.HistoryShareResolveRequest
	85,  // 11: xagent.gateway.v1.GatewayEnvelope.history_workdirs:type_name -> xagent.gateway.v1.HistoryWorkdirsRequest
	91,  // 12: xagent.gateway.v1.GatewayEnvelope.provider_list:type_name -> xagent.gateway.v1.ProviderListRequest
	93,  // 13: xagent.gateway.v1.GatewayEnvelope.settings_get:type_name -> xagent.gateway.v1.SettingsGetRequest
	95,  // 14: xagent.gateway.v1.GatewayEnvelope.settings_update:type_name -> xagent.gateway.v1.SettingsUpdateRequest
	100, // 15: xagent.gateway.v1.GatewayEnvelope.skill_files_list:type_name -> xagent.gateway.v1.SkillFilesListRequest
	102, // 16: xagent.gateway.v1.GatewayEnvelope.skill_metadata_read:type_name -> xagent.gateway.v1.SkillMetadataReadRequest
	104, // 17: xagent.gateway.v1.GatewayEnvelope.skill_text_read:type_name -> xagent.gateway.v1.SkillTextReadRequest
	108, // 18: xagent.gateway.v1.GatewayEnvelope.file_mention_list:type_name -> xagent.gateway.v1.FileMentionListRequest
	11,  // 19: xagent.gateway.v1.GatewayEnvelope.upload_readable_files:type_name -> xagent.gateway.v1.UploadReadableFilesRequest
	112, // 20: xagent.gateway.v1.GatewayEnvelope.fs_roots:type_name -> xagent.gateway.v1.FsRootsRequest
	114, // 21: xagent.gateway.v1.GatewayEnvelope.fs_list_dirs:type_name -> xagent.gateway.v1.FsListDirsRequest
	134, // 22: xagent.gateway.v1.GatewayEnvelope.ping:type_name -> xagent.gateway.v1.PingRequest
	13,  // 23: xagent.gateway.v1.GatewayEnvelope.uploaded_image_preview:type_name -> xagent.gateway.v1.UploadedImagePreviewRequest
	32,  // 24: xagent.gateway.v1.GatewayEnvelope.memory_manage:type_name -> xagent.gateway.v1.MemoryManageRequest
	106, // 25: xagent.gateway.v1.GatewayEnvelope.skill_manage:type_name -> xagent.gateway.v1.SkillManageRequest
	117, // 26: xagent.gateway.v1.GatewayEnvelope.fs_create_project_folder:type_name -> xagent.gateway.v1.FsCreateProjectFolderRequest
	34,  // 27: xagent.gateway.v1.GatewayEnvelope.terminal_request:type_name -> xagent.gateway.v1.TerminalRequest
	119, // 28: xagent.gateway.v1.GatewayEnvelope.fs_list:type_name -> xagent.gateway.v1.FsListRequest
	126, // 29: xagent.gateway.v1.GatewayEnvelope.fs_write_text:type_name -> xagent.gateway.v1.FsWriteTextRequest
	128, // 30: xagent.gateway.v1.GatewayEnvelope.fs_create_dir:type_name -> xagent.gateway.v1.FsCreateDirRequest
	130, // 31: xagent.gateway.v1.GatewayEnvelope.fs_rename:type_name -> xagent.gateway.v1.FsRenameRequest
	132, // 32: xagent.gateway.v1.GatewayEnvelope.fs_delete:type_name -> xagent.gateway.v1.FsDeleteRequest
	49,  // 33: xagent.gateway.v1.GatewayEnvelope.git_request:type_name -> xagent.gateway.v1.GitRequest
	122, // 34: xagent.gateway.v1.GatewayEnvelope.fs_read_editable_text:type_name -> xagent.gateway.v1.FsReadEditableTextRequest
	124, // 35: xagent.gateway.v1.GatewayEnvelope.fs_read_workspace_image:type_name -> xagent.gateway.v1.FsReadWorkspaceImageRequest
	37,  // 36: xagent.gateway.v1.GatewayEnvelope.sftp_request:type_name -> xagent.gateway.v1.SftpRequest
	137, // 37: xagent.gateway.v1.GatewayEnvelope.provider_models:type_name -> xagent.gateway.v1.ProviderModelsRequest
	97,  // 38: xagent.gateway.v1.GatewayEnvelope.settings_reset_ssh_known_host:type_name -> xagent.gateway.v1.SettingsResetSshKnownHostRequest
	55,  // 39: xagent.gateway.v1.GatewayEnvelope.chat_queue:type_name -> xagent.gateway.v1.ChatQueueRequest
	19,  // 40: xagent.gateway.v1.GatewayEnvelope.tunnel_state:type_name -> xagent.gateway.v1.TunnelStateSnapshot
	20,  // 41: xagent.gateway.v1.GatewayEnvelope.tunnel_mutation:type_name -> xagent.gateway.v1.TunnelMutation
	25,  // 42: xagent.gateway.v1.GatewayEnvelope.tunnel_frame:type_name -> xagent.gateway.v1.TunnelFrame
	26,  // 43: xagent.gateway.v1.GatewayEnvelope.workspace_watch:type_name -> xagent.gateway.v1.WorkspaceWatchRequest
	30,  // 44: xagent.gateway.v1.GatewayEnvelope.managed_process_request:type_name -> xagent.gateway.v1.ManagedProcessRequest
	74,  // 45: xagent.gateway.v1.GatewayEnvelope.history_branch:type_name -> xagent.gateway.v1.HistoryBranchRequest
	58,  // 46: xagent.gateway.v1.AgentEnvelope.chat_event:type_name -> xagent.gateway.v1.ChatEvent
	64,  // 47: xagent.gateway.v1.AgentEnvelope.cron_manage_resp:type_name -> xagent.gateway.v1.CronManageResponse
	66,  // 48: xagent.gateway.v1.AgentEnvelope.history_list_resp:type_name -> xagent.gateway.v1.HistoryListResponse
	69,  // 49: xagent.gateway.v1.AgentEnvelope.history_get_resp:type_name -> xagent.gateway.v1.HistoryGetResponse
	73,  // 50: xagent.gateway.v1.AgentEnvelope.history_rename_resp:type_name -> xagent.gateway.v1.HistoryRenameResponse
	89,  // 51: xagent.gateway.v1.AgentEnvelope.history_delete_resp:type_name -> xagent.gateway.v1.HistoryDeleteResponse
	90,  // 52: xagent.gateway.v1.AgentEnvelope.history_sync:type_name -> xagent.gateway.v1.HistorySyncEvent
	71,  // 53: xagent.gateway.v1.AgentEnvelope.history_prefix_resp:type_name -> xagent.gateway.v1.HistoryPrefixResponse
	77,  // 54: xagent.gateway.v1.AgentEnvelope.history_pin_resp:type_name -> xagent.gateway.v1.HistoryPinResponse
	80,  // 55: xagent.gateway.v1.AgentEnvelope.history_share_get_resp:type_name -> xagent.gateway.v1.HistoryShareGetResponse
	82,  // 56: xagent.gateway.v1.AgentEnvelope.history_share_set_resp:type_name -> xagent.gateway.v1.HistoryShareSetResponse
	84,  // 57: xagent.gateway.v1.AgentEnvelope.history_share_resolve_resp:type_name -> xagent.gateway.v1.HistoryShareResolveResponse
	87,  // 58: xagent.gateway.v1.AgentEnvelope.history_workdirs_resp:type_name -> xagent.gateway.v1.HistoryWorkdirsResponse
	92,  // 59: xagent.gateway.v1.AgentEnvelope.provider_list_resp:type_name -> xagent.gateway.v1.ProviderListResponse
	94,  // 60: xagent.gateway.v1.AgentEnvelope.settings_get_resp:type_name -> xagent.gateway.v1.SettingsGetResponse
	96,  // 61: xagent.gateway.v1.AgentEnvelope.settings_update_resp:type_name -> xagent.gateway.v1.SettingsUpdateResponse
	99,  // 62: xagent.gateway.v1.AgentEnvelope.settings_sync:type_name -> xagent.gateway.v1.SettingsSyncEvent
	101, // 63: xagent.gateway.v1.AgentEnvelope.skill_files_list_resp:type_name -> xagent.gateway.v1.SkillFilesListResponse
	103, // 64: xagent.gateway.v1.AgentEnvelope.skill_metadata_read_resp:type_name -> xagent.gateway.v1.SkillMetadataReadResponse
	105, // 65: xagent.gateway.v1.AgentEnvelope.skill_text_read_resp:type_name -> xagent.gateway.v1.SkillTextReadResponse
	110, // 66: xagent.gateway.v1.AgentEnvelope.file_mention_list_resp:type_name -> xagent.gateway.v1.FileMentionListResponse
	12,  // 67: xagent.gateway.v1.AgentEnvelope.upload_readable_files_resp:type_name -> xagent.gateway.v1.UploadReadableFilesResponse
	113, // 68: xagent.gateway.v1.AgentEnvelope.fs_roots_resp:type_name -> xagent.gateway.v1.FsRootsResponse
	135, // 69: xagent.gateway.v1.AgentEnvelope.pong:type_name -> xagent.gateway.v1.PongResponse
	116, // 70: xagent.gateway.v1.AgentEnvelope.fs_list_dirs_resp:type_name -> xagent.gateway.v1.FsListDirsResponse
	14,  // 71: xagent.gateway.v1.AgentEnvelope.uploaded_image_preview_resp:type_name -> xagent.gateway.v1.UploadedImagePreviewResponse
	33,  // 72: xagent.gateway.v1.AgentEnvelope.memory_manage_resp:type_name -> xagent.gateway.v1.MemoryManageResponse
	107, // 73: xagent.gateway.v1.AgentEnvelope.skill_manage_resp:type_name -> xagent.gateway.v1.SkillManageResponse
	118, // 74: xagent.gateway.v1.AgentEnvelope.fs_create_project_folder_resp:type_name -> xagent.gateway.v1.FsCreateProjectFolderResponse
	46,  // 75: xagent.gateway.v1.AgentEnvelope.terminal_response:type_name -> xagent.gateway.v1.TerminalResponse
	47,  // 76: xagent.gateway.v1.AgentEnvelope.terminal_event:type_name -> xagent.gateway.v1.TerminalEvent
	121, // 77: xagent.gateway.v1.AgentEnvelope.fs_list_resp:type_name -> xagent.gateway.v1.FsListResponse
	127, // 78: xagent.gateway.v1.AgentEnvelope.fs_write_text_resp:type_name -> xagent.gateway.v1.FsWriteTextResponse
	129, // 79: xagent.gateway.v1.AgentEnvelope.fs_create_dir_resp:type_name -> xagent.gateway.v1.FsCreateDirResponse
	131, // 80: xagent.gateway.v1.AgentEnvelope.fs_rename_resp:type_name -> xagent.gateway.v1.FsRenameResponse
	133, // 81: xagent.gateway.v1.AgentEnvelope.fs_delete_resp:type_name -> xagent.gateway.v1.FsDeleteResponse
	50,  // 82: xagent.gateway.v1.AgentEnvelope.git_response:type_name -> xagent.gateway.v1.GitResponse
	123, // 83: xagent.gateway.v1.AgentEnvelope.fs_read_editable_text_resp:type_name -> xagent.gateway.v1.FsReadEditableTextResponse
	125, // 84: xagent.gateway.v1.AgentEnvelope.fs_read_workspace_image_resp:type_name -> xagent.gateway.v1.FsReadWorkspaceImageResponse
	40,  // 85: xagent.gateway.v1.AgentEnvelope.sftp_response:type_name -> xagent.gateway.v1.SftpResponse
	41,  // 86: xagent.gateway.v1.AgentEnvelope.sftp_event:type_name -> xagent.gateway.v1.SftpEvent
	56,  // 87: xagent.gateway.v1.AgentEnvelope.chat_queue_resp:type_name -> xagent.gateway.v1.ChatQueueResponse
	57,  // 88: xagent.gateway.v1.AgentEnvelope.chat_queue_event:type_name -> xagent.gateway.v1.ChatQueueEvent
	59,  // 89: xagent.gateway.v1.AgentEnvelope.chat_control:type_name -> xagent.gateway.v1.ChatControlEvent
	61,  // 90: xagent.gateway.v1.AgentEnvelope.runtime_status:type_name -> xagent.gateway.v1.RuntimeStatusEvent
	98,  // 91: xagent.gateway.v1.AgentEnvelope.settings_reset_ssh_known_host_resp:type_name -> xagent.gateway.v1.SettingsResetSshKnownHostResponse
	60,  // 92: xagent.gateway.v1.AgentEnvelope.chat_runtime_snapshot:type_name -> xagent.gateway.v1.ChatRuntimeSnapshot
	138, // 93: xagent.gateway.v1.AgentEnvelope.provider_models_resp:type_name -> xagent.gateway.v1.ProviderModelsResponse
	16,  // 94: xagent.gateway.v1.AgentEnvelope.tunnel_desired:type_name -> xagent.gateway.v1.TunnelDesiredState
	21,  // 95: xagent.gateway.v1.AgentEnvelope.tunnel_mutation_result:type_name -> xagent.gateway.v1.TunnelMutationResult
	25,  // 96: xagent.gateway.v1.AgentEnvelope.tunnel_frame:type_name -> xagent.gateway.v1.TunnelFrame
	23,  // 97: xagent.gateway.v1.AgentEnvelope.tunnel_probe_report:type_name -> xagent.gateway.v1.TunnelProbeReport
	27,  // 98: xagent.gateway.v1.AgentEnvelope.workspace_activity:type_name -> xagent.gateway.v1.WorkspaceActivityEvent
	31,  // 99: xagent.gateway.v1.AgentEnvelope.managed_process_response:type_name -> xagent.gateway.v1.ManagedProcessResponse
	29,  // 100: xagent.gateway.v1.AgentEnvelope.managed_process_snapshot:type_name -> xagent.gateway.v1.ManagedProcessSnapshot
	75,  // 101: xagent.gateway.v1.AgentEnvelope.history_branch_resp:type_name -> xagent.gateway.v1.HistoryBranchResponse
	136, // 102: xagent.gateway.v1.AgentEnvelope.error:type_name -> xagent.gateway.v1.ErrorResponse
	10,  // 103: xagent.gateway.v1.UploadReadableFilesRequest.files:type_name -> xagent.gateway.v1.UploadReadableFile
	9,   // 104: xagent.gateway.v1.UploadReadableFilesResponse.files:type_name -> xagent.gateway.v1.ChatUploadedFile
	15,  // 105: xagent.gateway.v1.TunnelDesiredState.tunnels:type_name -> xagent.gateway.v1.TunnelSpec
	17,  // 106: xagent.gateway.v1.TunnelStatus.local:type_name -> xagent.gateway.v1.TunnelHealth
	18,  // 107: xagent.gateway.v1.TunnelStateSnapshot.tunnels:type_name -> xagent.gateway.v1.TunnelStatus
	17,  // 108: xagent.gateway.v1.TunnelStateSnapshot.relay:type_name -> xagent.gateway.v1.TunnelHealth
	17,  // 109: xagent.gateway.v1.TunnelProbeResult.local:type_name -> xagent.gateway.v1.TunnelHealth
	22,  // 110: xagent.gateway.v1.TunnelProbeReport.results:type_name -> xagent.gateway.v1.TunnelProbeResult
	0,   // 111: xagent.gateway.v1.TunnelFrame.kind:type_name -> xagent.gateway.v1.TunnelFrameKind
	24,  // 112: xagent.gateway.v1.TunnelFrame.headers:type_name -> xagent.gateway.v1.TunnelHeader
	1,   // 113: xagent.gateway.v1.TunnelFrame.ws_message_type:type_name -> xagent.gateway.v1.TunnelWsMessageType
	28,  // 114: xagent.gateway.v1.ManagedProcessSnapshot.processes:type_name -> xagent.gateway.v1.ManagedProcessRecord
	29,  // 115: xagent.gateway.v1.ManagedProcessResponse.snapshot:type_name -> xagent.gateway.v1.ManagedProcessSnapshot
	36,  // 116: xagent.gateway.v1.TerminalSession.ssh:type_name -> xagent.gateway.v1.TerminalSshMetadata
	38,  // 117: xagent.gateway.v1.SftpResponse.entries:type_name -> xagent.gateway.v1.SftpEntry
	38,  // 118: xagent.gateway.v1.SftpResponse.entry:type_name -> xagent.gateway.v1.SftpEntry
	39,  // 119: xagent.gateway.v1.SftpResponse.transfer:type_name -> xagent.gateway.v1.SftpTransfer
	39,  // 120: xagent.gateway.v1.SftpEvent.transfer:type_name -> xagent.gateway.v1.SftpTransfer
	44,  // 121: xagent.gateway.v1.TerminalSshTabsSnapshot.tabs:type_name -> xagent.gateway.v1.TerminalSshTab
	35,  // 122: xagent.gateway.v1.TerminalResponse.sessions:type_name -> xagent.gateway.v1.TerminalSession
	35,  // 123: xagent.gateway.v1.TerminalResponse.session:type_name -> xagent.gateway.v1.TerminalSession
	43,  // 124: xagent.gateway.v1.TerminalResponse.shell_options:type_name -> xagent.gateway.v1.TerminalShellOption
	42,  // 125: xagent.gateway.v1.TerminalResponse.ssh_prompt:type_name -> xagent.gateway.v1.TerminalSshPrompt
	45,  // 126: xagent.gateway.v1.TerminalResponse.ssh_tabs:type_name -> xagent.gateway.v1.TerminalSshTabsSnapshot
	35,  // 127: xagent.gateway.v1.TerminalEvent.session:type_name -> xagent.gateway.v1.TerminalSession
	45,  // 128: xagent.gateway.v1.TerminalEvent.ssh_tabs:type_name -> xagent.gateway.v1.TerminalSshTabsSnapshot
	35,  // 129: xagent.gateway.v1.TerminalStreamFrame.session:type_name -> xagent.gateway.v1.TerminalSession
	7,   // 130: xagent.gateway.v1.ChatRequest.selected_model:type_name -> xagent.gateway.v1.ChatSelectedModel
	9,   // 131: xagent.gateway.v1.ChatRequest.uploaded_files:type_name -> xagent.gateway.v1.ChatUploadedFile
	8,   // 132: xagent.gateway.v1.ChatRequest.runtime_controls:type_name -> xagent.gateway.v1.ChatRuntimeControls
	51,  // 133: xagent.gateway.v1.ChatCommandRequest.request:type_name -> xagent.gateway.v1.ChatRequest
	52,  // 134: xagent.gateway.v1.ChatCommandRequest.base_message_ref:type_name -> xagent.gateway.v1.ChatMessageRef
	53,  // 135: xagent.gateway.v1.ChatCommandRequest.cancel:type_name -> xagent.gateway.v1.CancelChatRequest
	2,   // 136: xagent.gateway.v1.ChatEvent.type:type_name -> xagent.gateway.v1.ChatEvent.ChatEventType
	62,  // 137: xagent.gateway.v1.RuntimeStatusEvent.active_runs:type_name -> xagent.gateway.v1.ChatRunReport
	62,  // 138: xagent.gateway.v1.RuntimeStatusEvent.finished_runs:type_name -> xagent.gateway.v1.ChatRunReport
	67,  // 139: xagent.gateway.v1.HistoryListResponse.conversations:type_name -> xagent.gateway.v1.ConversationSummary
	67,  // 140: xagent.gateway.v1.HistoryGetResponse.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	52,  // 141: xagent.gateway.v1.HistoryPrefixRequest.base_message_ref:type_name -> xagent.gateway.v1.ChatMessageRef
	67,  // 142: xagent.gateway.v1.HistoryPrefixResponse.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	67,  // 143: xagent.gateway.v1.HistoryRenameResponse.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	52,  // 144: xagent.gateway.v1.HistoryBranchRequest.base_message_ref:type_name -> xagent.gateway.v1.ChatMessageRef
	67,  // 145: xagent.gateway.v1.HistoryBranchResponse.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	67,  // 146: xagent.gateway.v1.HistoryPinResponse.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	78,  // 147: xagent.gateway.v1.HistoryShareGetResponse.share:type_name -> xagent.gateway.v1.HistoryShareStatus
	78,  // 148: xagent.gateway.v1.HistoryShareSetResponse.share:type_name -> xagent.gateway.v1.HistoryShareStatus
	67,  // 149: xagent.gateway.v1.HistoryShareResolveResponse.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	86,  // 150: xagent.gateway.v1.HistoryWorkdirsResponse.workdirs:type_name -> xagent.gateway.v1.HistoryWorkdirSummary
	67,  // 151: xagent.gateway.v1.HistorySyncEvent.conversation:type_name -> xagent.gateway.v1.ConversationSummary
	109, // 152: xagent.gateway.v1.FileMentionListResponse.entries:type_name -> xagent.gateway.v1.FileMentionEntry
	111, // 153: xagent.gateway.v1.FsRootsResponse.roots:type_name -> xagent.gateway.v1.FsRoot
	115, // 154: xagent.gateway.v1.FsListDirsResponse.entries:type_name -> xagent.gateway.v1.FsDirEntry
	120, // 155: xagent.gateway.v1.FsListResponse.entries:type_name -> xagent.gateway.v1.FsListEntry
