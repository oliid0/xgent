...
// producer of streaming previews (truncated text + __xagent_stream_preview
...
// attaching a __xagent_stream_preview meta block describing the original
...
func setPreviewMeta(container map[string]any, fieldName string, original string) {
	const metaKey = "__xagent_stream_preview"
