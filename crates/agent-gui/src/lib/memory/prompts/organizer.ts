...
export const ORGANIZER_SYSTEM_PROMPT = `# XAgent Memory Organizer

You are running an offline memory organization pass for XAgent.
...
export const TOPIC_CLUSTER_SYSTEM_PROMPT = `You are grouping existing XAgent memories for an offline organization pass.
