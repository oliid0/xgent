...
export const LIVEAGENT_PROXY_TOKEN_HEADER = "x-xagent-proxy-token";
export const LIVEAGENT_UPSTREAM_ORIGIN_HEADER = "x-xagent-upstream-origin";
export const LIVEAGENT_UPSTREAM_USER_AGENT_HEADER = "x-xagent-upstream-user-agent";
export const LIVEAGENT_UPSTREAM_CONTENT_TYPE_HEADER = "x-xagent-upstream-content-type";
// 布尔标记头：声明该请求经系统代理出网。代理地址/凭据只存于桌面 Rust 侧，
// 由本地反代按此头选择带代理的 client（x-xagent-* 头不会转发给上游）。
export const LIVEAGENT_USE_SYSTEM_PROXY_HEADER = "x-xagent-use-system-proxy";
