...
function buildSkillManagerErrorText(args: Record<string, unknown>, error: unknown) {
  ...
  lines.push(
    ...
    "Do not use Bash cat/ls/find/grep or absolute ~/.xagent/skills paths for Skill file access.",
  );
