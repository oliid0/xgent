...
const gatewayBridgeRequestRegistry = (() => {
  const root = globalThis as typeof globalThis & {
    __XAGENT_GATEWAY_BRIDGE_REQUESTS__?: GatewayBridgeRequestRegistry;
  };
  root.__XAGENT_GATEWAY_BRIDGE_REQUESTS__ ??= {
  ...
  root.__XAGENT_GATEWAY_BRIDGE_REQUESTS__.pendingConversationIds ??= new Set<string>();
  return root.__XAGENT_GATEWAY_BRIDGE_REQUESTS__;
})();
