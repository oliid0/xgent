...
const DEFAULT_UPDATE_REPOSITORY: &str = "Ohi01/XAgent";
    ...
    fn feed_entry(tag_name: &str) -> ReleaseFeedEntry {
        ReleaseFeedEntry {
            ...
            html_url: Some(format!(
                "https://github.com/Ohi01/XAgent/releases/tag/{tag_name}"
            )),
...
<feed xmlns="http://www.w3.org/2005/Atom">
  <entry>
    ...
    <link rel="alternate" type="text/html" href="https://github.com/Ohi01/XAgent/releases/tag/v0.1.2"/>
    <title>XAgent v0.1.2</title>
        ...
        assert_eq!(
            ...
            vec![ReleaseFeedEntry {
                ...
                html_url: Some(
                    "https://github.com/Ohi01/XAgent/releases/tag/v0.1.2".to_string()
                ),
    ...
    fn prerelease_channel_can_select_prerelease_manifest() {
        ...
        assert_eq!(
            ...
            "https://github.com/Ohi01/XAgent/releases/download/v0.1.2-beta.1/latest.json"
        );
