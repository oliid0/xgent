// Shared, runtime-agnostic shapes for the sidebar state layer. Platform
// differences belong in backend adapters, never here. All timestamps are
// epoch milliseconds; adapters normalize transport-specific fields first.
