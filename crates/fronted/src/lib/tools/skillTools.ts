...
function buildSkillManagerErrorText(args: Record<string, unknown>, error: unknown) {
  ...
  lines.push(
    ...
    "Do not use Bash cat/ls/find/grep or absolute ~/.xgent/skills paths for Skill file access.",
  );
