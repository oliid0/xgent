...
export const ORGANIZER_SYSTEM_PROMPT = `# Xgent Memory Organizer

You are running an offline memory organization pass for Xgent.
...
export const TOPIC_CLUSTER_SYSTEM_PROMPT = `You are grouping existing Xgent memories for an offline organization pass.
