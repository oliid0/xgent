...
export const translations: Record<ResolvedLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.changedFiles.title": "附件 · {count} 个文件",
    "chat.changedFiles.titleOne": "附件 · 1 个文件",
  ...
  "en-US": {
    ...
    "chat.changedFiles.title": "Attachments · {count} files",
    "chat.changedFiles.titleOne": "Attachments · 1 file",
