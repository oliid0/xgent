...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.mobileSsh.commandHint": "凭据只在本机安全存储中读取；每条命令独立执行，结果会保留在当前页面。",
  ...
  "en-US": {
    ...
    "chat.mobileSsh.commandHint": "Credentials are read only from secure local storage; each command runs independently and remains visible here.",
    "chat.mobileSsh.remoteCommandPlaceholder": "Remote command, for example uname -a",
    "chat.mobileSsh.interactiveUnsupported": "Keyboard-interactive authentication is unavailable in mobile command mode",
