...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.accessVaultPassphrase": "输入凭据库口令（至少 12 个字符）",
    "settings.accessLockVault": "锁定",
  ...
  "en-US": {
    ...
    "settings.accessVaultPassphrase": "Vault passphrase (at least 12 characters)",
    "settings.accessLockVault": "Lock",
