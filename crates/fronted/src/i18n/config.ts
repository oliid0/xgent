...
export const translations: Record<ResolvedLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.navMobileExecution": "本地运行环境",
    ...
    "settings.mobile.executionDescription": "管理 Android PRoot 或 iOS a-Shell 能力",
    "settings.mobile.assistantDescription": "语音输入、系统权限与设备服务",
    "settings.mobileAssistant.permissions": "个人助手权限",
  ...
  "en-US": {
    ...
    "settings.navMobileExecution": "Local Environment",
    ...
    "settings.mobile.executionDescription": "Manage Android PRoot or iOS a-Shell capabilities",
