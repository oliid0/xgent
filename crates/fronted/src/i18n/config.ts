...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.providerRuntimeResetDescription":
      "将关闭故障转移、清空备用队列，并恢复所有用量查询参数。供应商、API 凭据和模型不会被删除。",
  ...
  "en-US": {
    ...
    "settings.providerRuntimeResetDescription":
      "This disables failover, clears fallback queues, and restores usage-query defaults. Providers, API credentials, and models are kept.",
