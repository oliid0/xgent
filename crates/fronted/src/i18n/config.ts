...
export const translations: Record<ResolvedLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.mobileGit.hint": "可查看状态、未提交差异和最近提交；Android 使用 Git，iOS 可回退到 lg2。",
  ...
  "en-US": {
    ...
    "chat.mobileGit.hint":
      "Review status, local changes, and recent commits. Android uses Git and iOS can fall back to lg2.",
