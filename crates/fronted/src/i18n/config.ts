...
export const translations: Record<ResolvedLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "browser.startBrowsingDescription": "\u8f93\u5165\u7f51\u5740\u4ee5\u6253\u5f00\u9875\u9762",
    "chat.suggestBuildTitle": "\u6784\u5efa\u65b0\u529f\u80fd\u3001\u5e94\u7528\u6216\u5de5\u5177",
    "chat.suggestBuildPrompt":
      "\u5e2e\u6211\u6784\u5efa\u4e00\u4e2a\u65b0\u529f\u80fd\u3001\u5e94\u7528\u6216\u5de5\u5177\uff1a",
    ...
    "chat.trajectory.overview": "\u6982\u89c8",
    "chat.trajectory.input": "\u8f93\u5165",
    "chat.trajectory.systemPrompt": "\u7cfb\u7edf\u63d0\u793a\u8bcd",
    "chat.trajectory.tools": "\u5de5\u5177\u76ee\u5f55",
    "chat.trajectory.usage": "\u7528\u91cf",
    "chat.trajectory.diff": "\u63d0\u793a\u8bcd\u53d8\u66f4",
    "chat.trajectory.subagents": "\u5b50\u4ee3\u7406",
    "chat.trajectory.subagentsLoading":
      "\u6b63\u5728\u8bfb\u53d6\u5b50\u4ee3\u7406\u8f68\u8ff9\u2026",
    "chat.trajectory.subagentsFailed": "\u5b50\u4ee3\u7406\u8f68\u8ff9\u8bfb\u53d6\u5931\u8d25",
    "chat.trajectory.started": "\u5f00\u59cb\u65f6\u95f4",
    "chat.trajectory.duration": "\u6301\u7eed\u65f6\u95f4",
    "chat.trajectory.turnLabel": "\u5bf9\u8bdd\u8f6e\u6b21",
    "chat.trajectory.stepLabel": "\u6267\u884c\u6b65\u9aa4",
    "chat.trajectory.search": "\u641c\u7d22\u4e8b\u4ef6\u3001\u5de5\u5177\u6216\u6a21\u578b",
    "chat.trajectory.scale": "\u65f6\u95f4\u8f74\u6bd4\u4f8b",
    "chat.trajectory.actualTime": "\u5b9e\u9645\u65f6\u95f4",
    "chat.trajectory.sequence": "\u6267\u884c\u987a\u5e8f",
    "chat.trajectory.view": "\u8f68\u8ff9\u89c6\u56fe",
    "chat.trajectory.timelineView": "\u65f6\u95f4\u8f74",
    "chat.trajectory.tableView": "\u8868\u683c",
    "chat.trajectory.eventColumn": "\u4e8b\u4ef6",
    "chat.trajectory.typeColumn": "\u7c7b\u578b",
    "chat.trajectory.collapseTurns": "\u6298\u53e0\u5168\u90e8\u8f6e\u6b21",
    "chat.trajectory.expandTurns": "\u5c55\u5f00\u5168\u90e8\u8f6e\u6b21",
    "chat.trajectory.legend": "\u8f68\u8ff9\u7c7b\u578b\u56fe\u4f8b",
    "chat.trajectory.noMatches": "\u6ca1\u6709\u5339\u914d\u7684\u8f68\u8ff9\u4e8b\u4ef6",
    "chat.trajectory.clearSearch": "\u6e05\u9664\u641c\u7d22",
    "chat.trajectory.lane.user": "\u7528\u6237",
    "chat.trajectory.lane.context": "\u4e0a\u4e0b\u6587",
    "chat.trajectory.lane.model": "\u6a21\u578b",
    "chat.trajectory.lane.tool": "\u5de5\u5177",
    "chat.trajectory.lane.transport": "\u4f20\u8f93",
    "chat.trajectory.lane.warning": "\u91cd\u8bd5 / \u6545\u969c\u8f6c\u79fb",
    "chat.trajectory.lane.compaction": "\u538b\u7f29",
    "chat.trajectory.lane.system": "\u7cfb\u7edf",
    "chat.trajectory.event.user": "\u7528\u6237\u8f93\u5165",
    "chat.trajectory.event.context": "\u4e0a\u4e0b\u6587\u6ce8\u5165",
    "chat.trajectory.event.header": "\u8bf7\u6c42\u4e0a\u4e0b\u6587",
    "chat.trajectory.event.step_start": "\u6a21\u578b\u8bf7\u6c42\u5f00\u59cb",
    "chat.trajectory.event.first_token": "\u6536\u5230\u9996\u4e2a Token",
    "chat.trajectory.event.step_end": "\u6a21\u578b\u8bf7\u6c42\u5b8c\u6210",
    "chat.trajectory.event.retry": "\u8bf7\u6c42\u91cd\u8bd5",
    "chat.trajectory.event.failover": "\u5207\u6362\u5019\u9009\u6a21\u578b",
    "chat.trajectory.event.transport": "\u4f20\u8f93\u8def\u7531",
    "chat.trajectory.event.model_request": "\u539f\u59cb\u6a21\u578b\u8bf7\u6c42",
    "chat.trajectory.event.model_response": "\u539f\u59cb\u6a21\u578b\u54cd\u5e94",
    "chat.trajectory.event.model_result": "\u6a21\u578b\u54cd\u5e94\u7ed3\u679c",
    "chat.trajectory.event.model_error": "\u6a21\u578b\u8bf7\u6c42\u9519\u8bef",
    "chat.trajectory.event.tool_start": "\u5de5\u5177\u5f00\u59cb",
    "chat.trajectory.event.tool_end": "\u5de5\u5177\u5b8c\u6210",
    "chat.trajectory.event.compaction_start": "\u4e0a\u4e0b\u6587\u538b\u7f29\u5f00\u59cb",
    "chat.trajectory.event.compaction_end": "\u4e0a\u4e0b\u6587\u538b\u7f29\u5b8c\u6210",
    "chat.trajectory.event.turn_end": "\u672c\u8f6e\u5b8c\u6210",
    "app.settingsLoadFailed": "加载设置失败，已回退到默认配置。",
    "app.settingsSaveFailed": "保存设置失败。",
    "app.settingsReloadFailed": "重新加载设置失败，当前显示的是旧配置。",
    "app.settingsSshSettingsChanged": "SSH 设置已在其他位置更新，请检查最新内容后重试。",
    "tray.show": "显示主窗口",
    "tray.newChat": "新建对话",
    "tray.pin": "窗口置顶",
    "tray.recent": "最近对话",
    ...
    "appUpdate.restartToComplete": "更新已安装，重启后生效",
    "appUpdate.updateTo": "更新到 v{version}",
    "appUpdate.failedRetry": "更新失败：{message}。点击重试。",
    "appUpdate.runningTasksTitle": "仍有对话正在运行",
    "appUpdate.runningTasksDescription": "当前有 {count} 个对话仍在运行，立即重启会中断它们。",
    ...
    "chat.workspaceGroupCreate": "新建工作空间分组",
    "chat.workspaceGroupName": "分组名称",
    "chat.workspaceGroupMore": "更多分组操作",
    "chat.workspaceGroupRename": "重命名分组",
    "chat.workspaceGroupDelete": "删除分组",
    "chat.workspaceGroupSave": "保存分组",
    "chat.workspaceMoveToGroup": "移动到分组",
    ...
    "chat.conversationOpenInSplit": "在分屏中打开",
    "chat.conversationMove": "移动到工作空间",
    ...
    "chat.split.toolbar": "分屏对话",
    "chat.split.paneLabel": "分屏对话：{title}",
    "chat.split.continueHere": "在此继续",
    "chat.split.close": "关闭分屏",
    "chat.split.resize": "调整分屏宽度",
    "chat.split.loading": "正在加载对话",
    "chat.split.loadFailed": "无法加载分屏对话",
    "chat.split.retry": "重试",
    "chat.split.empty": "此对话尚无消息",
    "chat.delete": "删除",
    "chat.remove": "移除",
    ...
    "chat.history.search": "搜索历史会话",
    "chat.history.searchPlaceholder": "搜索标题和消息内容",
    "chat.history.searchClear": "清空搜索",
    "chat.history.searching": "正在搜索…",
    "chat.history.searchEmpty": "没有找到匹配的历史记录",
    "chat.history.searchFailed": "搜索历史记录失败",
    "chat.history.select": "选择会话",
    "chat.history.selectedCount": "已选 {count} 项",
    "chat.history.moveSelected": "移动所选会话",
    "chat.history.deleteSelected": "删除所选会话",
    "chat.history.confirmDeleteSelected": "再次点击确认删除",
    "chat.history.cancelSelection": "退出多选",
    ...
    "chat.history.moveFailed": "移动历史对话失败",
    ...
    "chat.resizeAuxiliaryPanel": "调整右侧工作区宽度",
    ...
    "chat.suggestIdeateTitle": "\u5ba1\u67e5\u4ee3\u7801\u5e76\u63d0\u51fa\u4fee\u6539\u5efa\u8bae",
    "chat.suggestIdeateHint": "从想法到落地方案",
    "chat.suggestIdeatePrompt":
      "\u8bf7\u5ba1\u67e5\u5f53\u524d\u9879\u76ee\u7684\u4ee3\u7801\uff0c\u627e\u51fa\u95ee\u9898\u5e76\u63d0\u51fa\u4fee\u6539\u5efa\u8bae\u3002",
    ...
    "settings.failover.failureThreshold": "熔断失败次数",
    "settings.failover.cooldown": "恢复冷却（秒）",
    "settings.failover.queue": "供应商优先级",
    "settings.failover.needProviders": "至少配置两个同协议供应商后才能建立备用队列。",
    "settings.failover.moveUp": "上移",
    "settings.failover.moveDown": "下移",
    "settings.failover.remove": "移除",
    "settings.providerRuntimeReset": "重置配置",
    "settings.providerRuntimeResetTitle": "重置供应商运行配置？",
    "settings.providerRuntimeResetDescription":
      "将关闭故障转移、清空备用队列，并恢复流式重试、错误重试与用量查询参数。供应商、API 凭据和模型不会被删除。",
    "settings.providerRuntimeResetConfirm": "重置运行配置",
    ...
    "settings.projectRoots.pick": "选择要授权的目录",
    "settings.projectRoots.empty": "尚未为该项目授权附加目录。",
    "settings.projectRoots.noProjects": "请先添加一个本地项目。",
    "settings.projectRoots.path": "目录路径",
    "settings.projectRoots.alias": "工具别名",
    "settings.projectRoots.read": "只读",
    "settings.projectRoots.write": "读写",
    "settings.projectRoots.remove": "移除目录",
    "settings.projectRoots.revoke": "全部撤销",
    ...
    "settings.projectRoots.mcp": "MCP 服务",
    "settings.projectRoots.resourcesEmpty": "暂无可选资源",
    "settings.projectRoots.disabled": "已停用",
    "chat.manualCompact": "立即压缩上下文",
    "chat.manualCompactTitle": "压缩上下文",
    "chat.manualCompactDescription":
      "压缩较早的对话内容以释放上下文空间，同时保留继续对话所需的关键信息。",
    "chat.manualCompactConfirm": "压缩",
    "chat.manualCompactComplete": "上下文压缩完成",
    "chat.manualCompactRejected": "当前会话正忙，暂时无法压缩",
    "chat.manualCompactBelowThreshold": "上下文用量尚未达到手动压缩阈值",
    "chat.manualCompactEmpty": "当前没有可压缩的消息",
    "chat.manualCompactUnavailable": "当前上下文无法压缩",
    "chat.manualCompactFailed": "上下文压缩失败",
    "chat.manualCompactCancelled": "已取消压缩",
    "chat.planMode.off": "进入计划模式",
    "chat.planMode.on": "退出计划模式",
    "chat.planMode.pending": "等待批准或修改意见",
    ...
    "chat.tasks.todo": "待办",
    "chat.tasks.completed": "待办已完成",
    "chat.tasks.progress": "任务完成进度",
    "chat.tasks.close": "关闭任务计划",
    ...
    "chat.thinking": "思考中",
    "chat.activity.edited": "编辑了 {count} 个文件",
    "chat.activity.read": "读取了 {count} 个文件",
    "chat.activity.commands": "运行的命令",
    "chat.activity.tools": "使用的工具",
    "chat.activity.title": "Xgent 的电脑",
    ...
    "chat.emptyRound": "（无回复）",
    "chat.inputHint": "输入消息，文件可从 + 添加，提示词可队列发送...",
    "chat.inputHintWithSkills": "输入消息，文件和 Skills 可从 + 添加，提示词可队列发送...",
    "chat.changedFiles.title": "已改动 {count} 个文件",
    "chat.changedFiles.titleOne": "已改动 1 个文件",
    "chat.changedFiles.undo": "撤销",
    "chat.cloudArtifacts.inline": "可查看文件：",
    ...
    "chat.changedFiles.expand": "显示其余 {count} 个文件",
    "chat.cloudArtifacts.title": "云端产物（{count}）",
    "chat.cloudArtifacts.titleOne": "云端产物",
    "chat.cloudArtifacts.hint": "点击可在应用内预览或编辑；其他类型会在文件管理器中定位",
    "chat.cloudArtifacts.open": "打开产物",
    "chat.cloudArtifacts.reveal": "打开产物所在文件夹",
    "chat.compactingContext": "正在压缩上下文",
    "chat.compactingContextWait": "正在压缩上下文，请稍候...",
    "chat.editMessage": "编辑消息",
    "chat.cancel": "取消",
    "chat.toolApproval.title": "{count} 项操作等待批准",
    "chat.toolApproval.approve": "允许",
    "chat.toolApproval.approveSession": "本会话允许",
    "chat.toolApproval.deny": "拒绝",
    "chat.toolApproval.approveAll": "全部允许",
    "chat.toolApproval.denyAll": "全部拒绝",
    "chat.toolApproval.failed": "提交工具批准决定失败",
    "settings.toolPolicy.allow": "允许",
    "settings.toolPolicy.ask": "询问",
    "settings.toolPolicy.deny": "禁止",
    ...
    "chat.composer.voiceInput": "语音输入",
    "chat.composer.voiceListening": "正在聆听…",
    "chat.composer.voicePermissionRequired": "需要麦克风和语音识别权限",
    "chat.composer.voiceNotConfigured": "请先在设置中启用并配置语音识别供应商",
    ...
    "chat.upload.add": "添加",
    "chat.upload.filesAndPhotos": "文件或照片",
    "chat.upload.camera": "相机",
    ...
    "chat.composer.plugins": "插件与技能",
    "chat.runtime.thinkHarder": "深度思考",
    "settings.desktopOnly": "此设置仅在桌面客户端中可用",
    "settings.cronHttpMethod": "请求方法",
    "settings.thirdPartySync": "从第三方同步",
    "settings.refreshLocalProviderConfigs": "重新扫描本地配置",
    ...
    "chat.workspaceMountDropNoProject": "请先选择一个项目，再拖入附加目录。",
    "chat.workspaceMountDropSuccess": "已挂载 {count} 个只读附加目录。",
    "chat.workspaceMountDropSkippedInside": "已跳过项目主目录内的 {count} 个目录。",
    "chat.workspaceMountDropSkippedOverlap": "已跳过与现有授权重叠的 {count} 个目录。",
    "chat.workspaceMountDropFailed": "处理拖入内容失败",
    ...
    "chat.image.previous": "上一张",
    "chat.image.next": "下一张",
    "chat.image.copy": "复制图片",
    "chat.image.save": "保存图片",
    "chat.image.openSystem": "用系统查看器打开",
    "chat.image.zoom": "缩放",
    ...
    "chat.tool.todoPending": "待处理",
    "chat.tool.todoInProgress": "进行中",
    "chat.tool.todoCompleted": "已完成",
    "chat.tool.expandActivity": "展开工具活动",
    "chat.tool.collapseActivity": "收起工具活动",
    "chat.tool.name.agent": "子代理",
    "chat.tool.name.askUser": "询问用户",
    "chat.tool.name.bash": "终端命令",
    "chat.tool.name.cron": "定时任务",
    "chat.tool.name.delete": "删除文件",
    "chat.tool.name.edit": "编辑文件",
    "chat.tool.name.glob": "查找文件",
    "chat.tool.name.grep": "搜索内容",
    "chat.tool.name.image": "查看图片",
    "chat.tool.name.list": "列出目录",
    "chat.tool.name.process": "后台进程",
    "chat.tool.name.mcp": "MCP 管理",
    "chat.tool.name.memory": "记忆管理",
    "chat.tool.name.read": "读取文件",
    "chat.tool.name.sendMessage": "发送消息",
    "chat.tool.name.skills": "技能管理",
    "chat.tool.name.ssh": "SSH 管理",
    "chat.tool.name.todo": "任务清单",
    "chat.tool.name.write": "写入文件",
    "chat.tool.action.add": "添加",
    "chat.tool.action.create": "创建",
    "chat.tool.action.delete": "删除",
    "chat.tool.action.disable": "停用",
    "chat.tool.action.enable": "启用",
    "chat.tool.action.get": "查看",
    "chat.tool.action.list": "列出",
    "chat.tool.action.read": "读取",
    "chat.tool.action.remove": "移除",
    "chat.tool.action.run": "运行",
    "chat.tool.action.update": "更新",
    "chat.askUser.question": "问题",
    "chat.askUser.recommended": "推荐",
    "chat.askUser.other": "其他",
    "chat.askUser.otherPlaceholder": "输入你的回答",
    "chat.askUser.cancelled": "已取消",
    "chat.askUser.timedOut": "已超时并采用推荐选项",
    "chat.askUser.answered": "已回答",
    "chat.askUser.submit": "提交回答",
    "chat.askUser.submitting": "正在提交",
    "chat.askUser.submitFailed": "提交回答失败",
    ...
    "sidebar.mobile.library": "资料库",
    "sidebar.mobile.projects": "项目",
    "sidebar.mobile.plugins": "插件",
    "sidebar.mobile.scheduled": "定时任务",
    "sidebar.mobile.remote": "远程控制",
    "sidebar.mobile.more": "更多",
    "sidebar.mobile.searchPlugins": "搜索插件",
    "sidebar.soul": "Soul 人设",
    "sidebar.soulMenu": "打开 Soul 与工作工具",
    "sidebar.soulPresets": "人设预设",
    "sidebar.addSoul": "新建人设",
    "sidebar.terminal": "终端",
    "sidebar.defaultTerminal": "默认终端",
    "sidebar.gitReview": "Git 审查",
    "sidebar.sshConnection": "SSH 连接",
    "sidebar.backgroundTasks": "后台任务",
    ...
    "projectTools.noProjectSelected": "请先选择一个工作空间",
    ...
    "projectTools.sshConnectionTitle": "SSH 连接",
    "projectTools.newSshConnection": "新建 SSH 连接",
    "projectTools.sshConnectionDescription": "启动交互式 SSH 终端并关联项目主机",
    "projectTools.sshConnectionSettings": "设置 SSH 主机",
    "projectTools.sshConnectionBack": "返回 SSH",
    "projectTools.sshConnectionScopeGroup": "切换 SSH 连接视角",
    "projectTools.sshConnectionScopeProject": "项目SSH",
    "projectTools.sshConnectionScopeAll": "全局SSH",
    "projectTools.sshConnectionConfiguredHosts": "已关联 {count} 台 SSH 主机",
    "projectTools.sshConnectionNoProject": "选择项目后可关联 SSH 主机",
    "projectTools.sshConnectionProjectEmpty": "当前项目暂无 SSH 连接",
    "projectTools.sshConnectionProjectEmptyHint":
      "先关联设置中已配置的 SSH 主机，然后在这里启动交互式终端。",
    "projectTools.sshConnectionProjectEmptyWithHosts": "选择已关联主机即可启动 SSH 终端。",
    "projectTools.sshConnectionAllEmpty": "暂无 SSH 连接",
    "projectTools.sshConnectionAllEmptyHint": "当前没有运行中的 SSH 终端。",
    "projectTools.sshConnectionAssociateHosts": "关联 SSH 主机",
    "projectTools.sshConnectionAssociateHostsHint":
      "从 Settings > SSH 已配置主机中选择当前项目可用的主机",
    "projectTools.sshConnectionAssociatedCount": "已关联",
    "projectTools.sshConnectionNoConfiguredHosts": "还没有配置 SSH 主机",
    "projectTools.sshConnectionNoConfiguredHostsHint":
      "请先到 Settings > SSH 添加或导入主机，再回到这里关联当前项目。",
    "projectTools.sshConnectionCreateTitle": "新建 SSH 连接",
    "projectTools.sshConnectionCreateHint": "选择主机并打开交互式 SSH 终端。",
    "projectTools.sshConnectionCreateNoAssociatedHosts": "当前项目还没有关联 SSH 主机",
    "projectTools.sshConnectionCreateNoAssociatedHostsHint":
      "先关联 Settings > SSH 中的主机，再从这里新建 SSH 连接。",
    "projectTools.sshConnectionHost": "SSH 主机",
    "projectTools.sshConnectionSftpEnabled": "SFTP功能",
    "projectTools.sshConnectionNote": "备注",
    "projectTools.sshConnectionNotePlaceholder": "可选：记录用途或访问说明",
    "projectTools.sshConnectionCreate": "创建连接",
    "projectTools.sshConnectionCreateCancel": "取消",
    "projectTools.sshConnectionCreateUnavailable": "当前仅提供界面，启动功能将在后续接入",
    "projectTools.sshConnectionConnect": "连接",
    "projectTools.sshConnectionConnecting": "连接中",
    "projectTools.sshConnectionTabTitle": "标签标题",
    "projectTools.sshConnectionTabTitlePlaceholder": "默认使用主机名称",
    "projectTools.sshConnectionProxyUnsupported": "该主机配置了 proxy，连接时会通过代理拨号。",
    "projectTools.sshConnectionMissingSecret": "该主机缺少已保存的认证凭据。",
    "projectTools.sshConnectionRunningCount": "{count} 个 SSH 连接运行中",
    "projectTools.sshConnectionConnectionCount": "{count} 个 SSH 连接，{connected} 个已连接",
    "projectTools.sshConnectionCloseSession": "关闭 SSH 连接",
    ...
    "projectTools.sshConnectionConnected": "已连接",
    "projectTools.sshConnectionReconnecting": "重连中 {attempt}/{max}",
    "projectTools.sshConnectionDisconnected": "已断连",
    "projectTools.sshConnectionLatencyUnknown": "延迟 --",
    "projectTools.sshConnectionLatencyChecking": "检测延迟",
    "projectTools.sshConnectionLatencyValue": "延迟 {ms}ms",
    "projectTools.sshConnectionOpenBash": "进入 Bash 交互",
    "projectTools.sshConnectionOpenSftp": "打开 SFTP 文件管理",
    "projectTools.sshConnectionPromptTitle": "确认 SSH 主机密钥",
    "projectTools.sshConnectionAuthPromptTitle": "SSH 认证",
    "projectTools.sshConnectionTrustHost": "信任并连接",
    "projectTools.sshConnectionRejectHost": "取消",
    "projectTools.sshConnectionPromptCancel": "取消",
    "projectTools.sshConnectionPromptSubmit": "继续连接",
    "projectTools.sshConnectionFingerprint": "指纹",
    "projectTools.sshConnectionKeyType": "密钥类型",
    ...
    "projectTools.closeSshConnectionTab": "关闭 SSH 连接",
    ...
    "projectTools.gitReview.worktrees": "Git Worktree",
    "projectTools.gitReview.manageWorktrees": "管理 Worktree",
    "projectTools.gitReview.createWorktree": "创建 Worktree",
    "projectTools.gitReview.worktreeBranch": "新分支名称",
    "projectTools.gitReview.worktreeDirectory": "目录名称",
    "projectTools.gitReview.worktreeStartPoint": "起点（默认 HEAD）",
    "projectTools.gitReview.worktreeParent": "父目录（留空使用应用目录）",
    "projectTools.gitReview.noWorktrees": "当前仓库没有关联 Worktree",
    "projectTools.gitReview.deleteWorktreeBranch": "同时删除已合并分支",
    "projectTools.gitReview.forceRemoveWorktree": "强制移除含未提交改动的 Worktree",
    ...
    "git.branchSelector.back": "返回 Git 仓库",
    "git.branchSelector.loading": "正在刷新仓库状态",
    ...
    "projectTools.gitReview.initSuccessMessage": "Git 仓库已初始化。",
    ...
    "projectTools.resizePanelWidth": "调整工具面板宽度",
    ...
    "projectTools.fileTree.importFile": "导入文件",
    "projectTools.fileTree.importTooLarge": "{file} 超过 20 MB 文件大小限制",
    ...
    "projectTools.fileTree.openExternal": "\u6253\u5f00\u65b9\u5f0f",
    ...
    "workspaceSshTerminal.localForward": "SSH 本地端口转发",
    "workspaceSshTerminal.forwardRemoteHost": "远端主机",
    "workspaceSshTerminal.forwardRemotePort": "远端端口",
    "workspaceSshTerminal.forwardLocalPort": "本地端口",
    ...
    "workspaceEditor.run": "运行",
    "workspaceEditor.running": "正在运行...",
    "workspaceEditor.runOutput": "运行输出",
    "workspaceEditor.runSucceeded": "运行完成",
    "workspaceEditor.runFailed": "运行失败",
    "workspaceEditor.exitCode": "退出码",
    "workspaceEditor.noRunOutput": "命令没有输出。",
    "workspaceEditor.closeRunOutput": "关闭",
    "workspaceEditor.moreActions": "更多编辑操作",
    ...
    "workspaceFilePreview.preview": "预览",
    "workspaceFilePreview.source": "源码",
    "workspaceFilePreview.copySource": "复制原文",
    "workspaceFilePreview.copied": "已复制",
    "workspaceFilePreview.copyFailed": "复制失败",
    "workspaceFilePreview.openExternal": "\u6253\u5f00\u65b9\u5f0f",
    "workspaceFilePreview.openExternalFailed": "用默认应用打开失败",
    "workspaceFilePreview.reload": "重新加载",
    "workspaceFilePreview.close": "关闭预览",
    "workspaceFilePreview.maximize": "在主聊天区最大化",
    "workspaceFilePreview.restoreSidePanel": "恢复右侧预览",
    ...
    "settings.navToolPermissions": "工具权限",
    ...
    "settings.commandSafety.askDesc": "每次执行可修改系统状态的命令前都请求确认。",
    "settings.commandSafety.sandbox": "沙箱",
    "settings.commandSafety.sandboxDesc": "在允许联网的系统沙箱中运行命令。",
    "settings.commandSafety.sandboxOffline": "离线沙箱",
    "settings.commandSafety.sandboxOfflineDesc": "在禁止联网的系统沙箱中运行命令。",
    "settings.stt.title": "云端实时语音识别",
    "settings.stt.desc": "使用自有云服务凭据把麦克风语音实时转成输入框文字；识别结果不会自动发送。",
    "settings.stt.provider": "语音识别供应商",
    "settings.stt.secretSaved": "已安全保存；留空表示不修改",
    "settings.stt.test": "保存并测试连接",
    "settings.stt.test.connected": "连接成功",
    "settings.stt.test.connected_no_speech": "连接成功（测试音频未检测到语音）",
    "settings.stt.test.timeout": "连接超时",
    "settings.stt.test.authentication_failed": "鉴权失败",
    ...
    "settings.usage.mode.general": "通用余额脚本",
    "settings.usage.mode.newapi": "NewAPI",
    "settings.usage.mode.custom": "自定义脚本",
    "settings.usage.timeout": "超时（秒）",
    "settings.usage.baseUrl": "查询 Base URL（留空沿用供应商）",
    "settings.usage.secretSaved": "已安全保存",
    "settings.usage.providerCredential": "留空沿用供应商凭据",
    "settings.usage.script": "查询脚本",
    "settings.usage.scriptRequired": "自定义模式必须提供脚本",
    "settings.usage.scriptPreset": "留空使用内置模板，填写后使用可编辑副本",
    "settings.usage.test": "测试查询",
    "settings.usage.refresh": "刷新用量",
    "settings.usage.remaining": "剩余",
    "settings.usage.saveBeforeTest": "先保存供应商，再测试用量查询。",
    "settings.usage.testSuccess": "查询成功，返回 {count} 条用量记录。",
    ...
    "settings.shortcutToggleDesc": "在显示和隐藏之间切换",
    "settings.shortcutNewChat": "新建对话",
    "settings.shortcutNewChatDesc": "打开窗口并开始新对话",
    "settings.shortcutPin": "切换置顶",
    "settings.shortcutPinDesc": "切换窗口始终置顶状态",
    "settings.shortcutNotSet": "未设置",
    "settings.shortcutSet": "设置快捷键",
    "settings.shortcutChange": "更改快捷键",
    "settings.shortcutClear": "清除快捷键",
    "settings.shortcutToggleOnOff": "启用或停用快捷键",
    "settings.shortcutPressEnter": "按 Enter 保存",
    "settings.shortcutRecordingHint": "请按下修饰键和一个主键",
    "settings.shortcutNeedMainKey": "快捷键必须包含一个非修饰键",
    "settings.shortcutConflict": "该快捷键已用于其他动作",
    "settings.shortcutOccupied": "快捷键已被系统或其他应用占用",
    "settings.shortcutRegisterFailed": "部分快捷键注册失败",
    "settings.shortcutSaved": "快捷键已保存",
    "settings.shortcutRestoreDefaults": "恢复默认",
    "settings.shortcutKeyboardTitle": "键盘布局预览",
    ...
    "settings.backupLocalDesc": "导出或导入设置、服务配置和技能数据",
    "settings.backupExport": "导出备份",
    "settings.backupImport": "导入备份",
    "settings.backupExportDone": "备份已导出",
    "settings.backupExportFailed": "导出备份失败",
    "settings.backupImportDone": "备份已导入",
    "settings.backupImportFailed": "导入备份失败",
    "settings.backupImportConfirmTitle": "导入此备份？",
    "settings.backupImportConfirmSubtitle": "当前设置将被备份内容更新",
    "settings.backupImportConfirmAction": "导入",
    "settings.backupCancel": "取消",
    "settings.backupScopeTitle": "备份内容",
    "settings.backupScopeDesc": "敏感凭据会按安全规则处理",
    "settings.backupDomainProviders": "服务商",
    "settings.backupDomainMcp": "MCP",
    "settings.backupDomainSystem": "系统",
    ...
    "settings.backupSyncDesc": "通过你自己的 WebDAV 存储同步加密备份",
    "settings.backupSyncPreset": "服务预设",
    ...
    "settings.backupSyncPasswordSaved": "已安全保存密码；留空表示不修改",
    "settings.backupSyncRemoteDir": "远端目录",
    "settings.backupSyncProfile": "配置名称",
    "settings.backupSyncProfileHint": "多个设备使用相同名称即可共享备份",
    "settings.backupSyncAuto": "自动同步",
    "settings.backupSyncAutoHint": "设置变更后自动防抖上传",
    "settings.backupAutoBackupHint": "启用前会先保存并测试连接",
    "settings.backupSyncSave": "保存",
    "settings.backupSyncTest": "测试连接",
    "settings.backupSyncUpload": "上传",
    "settings.backupSyncDownload": "下载并应用",
    "settings.backupSyncDirtyHint": "本地设置有未上传的变化",
    "settings.backupSyncLastAt": "上次同步：{time}",
    "settings.backupSyncRemoteEmpty": "远端尚无备份",
    "settings.backupSyncSaveDone": "同步设置已保存",
    "settings.backupSyncSaveFailed": "保存同步设置失败",
    "settings.backupSyncTestDone": "连接测试成功",
    "settings.backupSyncTestFailed": "连接测试失败",
    "settings.backupSyncSaveAndTestDone": "设置已保存且连接成功",
    "settings.backupSyncSaveAndTestFailed": "设置已保存，但连接测试失败",
    "settings.backupSyncUploadDone": "备份已上传",
    "settings.backupSyncUploadFailed": "上传备份失败",
    "settings.backupSyncDownloadDone": "远端备份已应用",
    "settings.backupSyncDownloadFailed": "下载备份失败",
    "settings.backupSyncUploadConfirmTitle": "上传当前备份？",
    "settings.backupSyncUploadConfirmSubtitle": "远端同名备份将被更新",
    "settings.backupSyncDownloadConfirmTitle": "应用远端备份？",
    "settings.backupSyncDownloadConfirmSubtitle": "当前设置将被远端内容更新",
    "settings.backupSyncAutoConfirmTitle": "启用自动同步？",
    "settings.backupSyncAutoConfirmSubtitle": "后续设置变更会自动上传",
    "settings.backupSyncAutoConfirmDesc": "启用前将保存配置并验证连接。",
    "settings.backupSyncAutoConfirmAction": "启用",
    "settings.backupSyncAutoDone": "自动同步已启用",
    "settings.backupSyncAutoErrorTitle": "无法启用自动同步",
    "settings.navSystem": "系统设置",
    "settings.navSystemTools": "系统工具",
    "settings.navProviders": "供应商配置",
    "settings.navSoul": "Soul 人设",
    "settings.navHooks": "Hooks",
    "settings.navOther": "其他",
    "settings.mobile.otherDescription": "集中管理 Hooks、定时任务和 SSH 连接",
    "settings.navAgents": "全局提示词",
    "settings.navSsh": "SSH",
    "settings.navCron": "Cron",
    "settings.navRemote": "Remote",
    "settings.navAccess": "本地与云",
    "settings.navMobileExecution": "Shell 管理",
    "settings.navMobileAssistant": "个人助手",
    ...
    "settings.mobile.appearanceGroup": "外观与模型",
    "settings.mobile.personalGroup": "个性化",
    "settings.mobile.capabilitiesGroup": "能力与连接",
    "settings.mobile.systemDescription": "外观、语言、工作目录与运行偏好",
    "settings.mobile.providersDescription": "模型供应商、OAuth 与模型选择",
    "settings.mobile.soulDescription": "名称、人格、语气与回复语言",
    "settings.mobile.agentsDescription": "全局提示词与智能体行为",
    "settings.mobile.memoryDescription": "长期记忆、项目记忆与整理策略",
    "settings.mobile.skillsDescription": "管理已安装技能、商店与本地导入",
    "settings.mobile.mcpDescription": "管理 MCP 服务、注册表与本地导入",
    "settings.mobile.systemToolsDescription": "本地执行工具与安全策略",
    "settings.mobile.hooksDescription": "在关键事件发生时自动执行操作",
    "settings.mobile.cronDescription": "定时运行智能体任务",
    "settings.mobile.sshDescription": "远程主机和终端连接",
    "settings.mobile.accessDescription": "连接局域网电脑与配置云端执行",
    "settings.mobile.executionDescription": "初始化并管理 Shell 环境",
    "settings.mobile.assistantDescription": "语音输入、系统权限与设备服务",
    "settings.mobileAssistant.permissions": "个人助理权限",
    "settings.native.back": "返回",
    "settings.native.shellTitle": "Shell 管理",
    "settings.native.shellEnvironment": "Shell 环境",
    "settings.native.shellInstalling": "正在安装 Shell 环境",
    "settings.native.shellInstallingEssentials": "正在安装 Bash 和 Linux 常用工具",
    "settings.native.shellEssentialsError":
      "Alpine 已安装且可离线使用，但 Bash 和 Linux 常用工具需要联网安装：{detail}",
    "settings.native.network": "网络",
    "settings.native.cellular": "蜂窝网络",
    "settings.native.ethernet": "以太网",
    "settings.native.offline": "离线",
    "settings.native.otherNetwork": "其他网络",
    "settings.native.unavailable": "不可用",
    "settings.native.installed": "已安装",
    "settings.native.notInstalled": "未安装",
    "settings.native.status": "状态",
    "settings.native.backend": "后端",
    "settings.native.version": "版本",
    "settings.native.size": "大小",
    "settings.native.actions": "操作",
    "settings.native.toolchains": "工具链",
    "settings.native.ready": "可用",
    "settings.native.folders": "文件夹",
    "settings.native.theme": "主题",
    "settings.native.appearance": "外观",
    "settings.native.system": "跟随系统",
    "settings.native.light": "浅色",
    "settings.native.dark": "深色",
    "settings.native.showReasoning": "显示思考过程",
    "settings.native.appSettings": "应用设置",
    "settings.native.accessibilityNote": "字号、对比度和减弱动态效果跟随系统辅助功能设置。",
    "settings.native.addProvider": "添加服务商",
    "settings.native.newProvider": "新服务商",
    "settings.native.name": "名称",
    "settings.native.api": "接口",
    "settings.native.exactEndpoint": "使用完整接口地址",
    "settings.native.requestFormat": "请求格式",
    "settings.native.fetchModels": "获取模型",
    "settings.native.enabledModels": "启用的模型",
    "settings.native.addModel": "添加模型",
    "settings.native.add": "添加",
    "settings.native.deleteProvider": "删除这个供应商？",
    "settings.native.deleteProviderDetail": "将移除其本地凭据和模型配置。",
    "settings.native.organizeMemory": "自动整理记忆",
    "settings.native.scope": "范围",
    "settings.native.deleteMcp": "删除 {name}？",
    "settings.native.connectMcp": "连接 MCP 服务",
    "settings.native.transport": "传输方式",
    "settings.native.command": "命令",
    "settings.native.arguments": "参数（每行一个）",
    "settings.native.connect": "连接",
    "settings.native.speechChecking": "正在检查系统语音识别",
    "settings.native.speechAvailable": "系统语音识别可用",
    "settings.native.speechUnavailable": "系统语音识别不可用",
    "settings.native.aliyun": "阿里云 DashScope",
    "settings.native.tencent": "腾讯云 ASR",
    "settings.native.volcengineV2": "火山引擎 ASR v2",
    ...
    "settings.mobileAssistant.remindersDescription": "允许个人助手处理提醒事项。",
    "settings.mobileAssistant.photos": "照片",
    ...
    "settings.mobileAssistant.denied": "已拒绝",
    "settings.mobileAssistant.requested": "已完成授权请求",
    "settings.mobileAssistant.notRequested": "点击授权",
    "settings.mobileAssistant.platformServices": "平台服务",
    ...
    "settings.soulDeletePresetConfirm": "删除后无法恢复。其他人设不会受到影响。",
    "settings.soulDescription": "SOUL.md 是跨对话生效的持久人格文件，只控制身份、语气与表达偏好。",
    "settings.soulIdentityGroup": "身份",
    "settings.soulVoiceGroup": "人格与表达",
    "settings.soulName": "名称",
    "settings.soulNameHint": "显示在侧边栏和助手身份中的名称",
    "settings.soulLanguage": "默认语言",
    "settings.soulLanguageHint": "自动时跟随用户当前使用的语言",
    "settings.soulLanguageAuto": "自动",
    "settings.soulStyle": "回复风格",
    "settings.soulStyleHint": "简短描述语气、格式和表达习惯",
    "settings.soulStylePlaceholder": "例如：简洁、直接，优先给出结论",
    "settings.soulPersonality": "人格正文",
    "settings.soulPersonalityHint": "使用 Markdown 描述立场、性格与协作方式",
    "settings.soulCharacters": "字符",
    "settings.soulWords": "词",
    "settings.soulSave": "保存",
    "settings.soulSaved": "SOUL.md 已保存，下一次任务立即生效。",
    "settings.soulReload": "重新载入",
    "settings.soulLoading": "正在载入 SOUL.md",
    "chat.mobileActivity.title": "任务活动",
    "chat.mobileActivity.live": "实时",
    "chat.mobileActivity.working": "正在执行",
    "chat.mobileActivity.running": "智能体正在使用工具",
    "chat.mobileActivity.awaitingResult": "尚未收到执行结果",
    "chat.mobileActivity.recent": "当前对话的工具记录",
    "chat.mobileActivity.close": "关闭任务活动",
    "chat.mobileActivity.empty": "暂无任务活动",
    "chat.mobileActivity.emptyDescription":
      "智能体运行 Shell、浏览器或其他工具时，执行过程会显示在这里。",
    "chat.mobileActivity.noArguments": "无参数",
    "chat.mobileActivity.input": "输入",
    "chat.mobileActivity.output": "输出",
    "chat.mobileActivity.round": "第 {round} 轮",
    "chat.mobileMenu.title": "工作工具",
    "chat.mobileMenu.terminal": "打开终端",
    "chat.mobileMenu.rootfs": "Shell 管理",
    "chat.mobileMenu.browser": "打开浏览器",
    "chat.mobileMenu.browserSettings": "浏览器设置",
    "chat.mobileMenu.gitReview": "Git 审查",
    "chat.mobileMenu.ssh": "SSH 连接",
    "chat.mobileMenu.background": "后台任务",
    "chat.mobileTerminal.title": "移动终端",
    "chat.mobileTerminal.clear": "清空终端记录",
    "chat.mobileTerminal.close": "关闭移动终端",
    "chat.mobileTerminal.ready": "终端已连接到当前工作空间",
    "chat.mobileTerminal.workspaceHint":
      "Android 命令在 PRoot/Alpine 中执行；iOS 命令由 a-Shell 框架执行。生成的文件保存在上方工作空间路径。",
    "chat.mobileTerminal.running": "命令正在运行",
    "chat.mobileTerminal.exitCode": "退出码：{code}",
    "chat.mobileTerminal.placeholder": "输入命令",
    "chat.mobileTerminal.noWorkspace": "请先选择工作空间",
    "chat.mobileTerminal.stop": "停止命令",
    "chat.mobileTerminal.run": "运行命令",
    "chat.mobileGit.title": "Git 审查",
    "chat.mobileGit.authorName": "Git 作者姓名",
    "chat.mobileGit.authorEmail": "Git 作者邮箱",
    "chat.mobileGit.ready": "检查当前工作空间的版本状态",
    "chat.mobileGit.hint": "使用原生 Git 查看状态、差异和提交历史，无需设备上的命令行工具。",
    "chat.mobileGit.status": "状态",
    "chat.mobileGit.changes": "更改",
    "chat.mobileGit.history": "历史",
    "chat.mobileGit.back": "返回 Git 列表",
    "chat.mobileSsh.title": "SSH 连接",
    "chat.mobileSsh.ready": "从已保存主机或命令开始连接",
    "chat.mobileSsh.hint": "选择主机会填入安全的 SSH 命令；密钥请放在移动 Shell 可访问的位置。",
    "chat.mobileSsh.placeholder": "ssh user@host 或远程命令",
    "chat.mobileSsh.savedHosts": "已保存的主机",
    "chat.mobileSsh.back": "返回主机列表",
    "chat.mobileSsh.commandMode": "远程命令模式",
    "chat.mobileSsh.commandHint":
      "凭据只在本机安全存储中读取；每条命令独立执行，结果会保留在当前页面。",
    "chat.mobileSsh.remoteCommandPlaceholder": "输入远程命令，例如 uname -a",
    "chat.mobileSsh.interactiveUnsupported": "移动命令模式不支持键盘交互认证",
    "chat.mobileSsh.keyboardResponse": "键盘交互回答",
    "chat.mobileSsh.keyboardResponseHint":
      "输入服务器本次认证问题的回答，然后执行远程命令；回答只用于本次连接。",
    "chat.mobileSsh.keyboardResponsePlaceholder": "本次认证回答",
    "chat.mobileSsh.associated": "项目主机",
    "chat.mobileSsh.associateHost": "关联到当前项目",
    "chat.mobileSsh.removeAssociation": "取消当前项目关联",
    "chat.mobileWorkspace.new": "新建工作空间",
    "chat.mobileWorkspace.hint":
      "工作空间创建在 XGent 的应用目录中，终端与智能体生成的文件都会保存在这里。",
    "chat.mobileWorkspace.name": "工作空间名称",
    "chat.mobileWorkspace.placeholder": "例如：我的 Python 项目",
    "chat.mobileWorkspace.create": "创建工作空间",
    "chat.mobileWorkspace.creating": "正在创建",
    "chat.mobileWorkspace.or": "或者",
    "chat.mobileWorkspace.chooseFolder": "选择设备上的文件夹",
    "chat.mobileWorkspace.chooseFolderHint":
      "Android 会持久化 SAF 授权并挂载到 PRoot；iOS 会保存安全作用域书签并供 a-Shell 使用。",
    "chat.clone.title": "克隆远程仓库",
    "chat.clone.newTab": "新建文件夹",
    "chat.clone.cloneTab": "克隆仓库",
    "chat.clone.remoteUrl": "远程仓库地址",
    "chat.clone.branch": "分支（可选）",
    "chat.clone.defaultBranch": "使用默认分支",
    "chat.clone.loadBranches": "读取分支",
    "chat.clone.chooseDestination": "选择目标父目录",
    "chat.clone.start": "开始克隆",
    "chat.clone.starting": "正在启动",
    "chat.clone.cancel": "取消克隆",
    "chat.clone.cancelling": "正在取消",
    "chat.clone.dismiss": "关闭克隆任务",
    "chat.clone.open": "打开工作空间",
    "settings.mobileExternalWorkspaces": "外部工作空间",
    "settings.mobileExternalWorkspacesHint": "授权后，终端、智能体和“我的文件”会共享这个目录。",
    "settings.mobileMountFolder": "挂载文件夹",
    "settings.mobileNoExternalWorkspaces": "尚未挂载外部工作空间",
    "settings.mobileReadWrite": "读写",
    "settings.mobileReadOnly": "只读",
    "browser.title": "浏览器",
    "browser.open": "打开内置浏览器",
    "browser.close": "关闭浏览器",
    ...
    "browser.agentOperating": "智能体正在操作此浏览器会话",
    "browser.sharedSession": "你和智能体共享同一浏览器会话",
    "browser.takeOver": "协助操作",
    "browser.finishAssistance": "完成协助",
    "browser.assistanceActive": "正在由你操作；完成后智能体会读取新页面并继续",
    "browser.dismissError": "关闭",
    "browser.remoteHostTitle": "浏览器正在电脑端运行",
    "browser.remoteHostDescription":
      "当前是局域网 Web UI。智能体仍可操作电脑端浏览器；实时画面需要在电脑客户端查看。",
    "browser.homePage": "主页",
    "browser.automation": "智能体自动化",
    "browser.privacy": "隐私与会话",
    "browser.clearSessions": "关闭并清除全部浏览器会话",
    ...
    "settings.reorderVerticalHint": "拖动排序；键盘可使用上下方向键、Home 或 End",
    ...
    "settings.codeFontFamily": "代码与终端字体",
    "settings.fontFamilyDefault": "跟随内置字体",
    "settings.fontFamilyCustom": "自定义",
    "settings.fontFamilyPlaceholder": "输入字体族名称",
    "settings.fontSizeSidebar": "会话列表",
    "settings.fontSizeChat": "聊天区域",
    "settings.fontSizeWorkspaceTools": "工具面板",
    ...
    "settings.builtinTool.task_create.desc": "向当前运行的权威任务列表添加步骤",
    "settings.builtinTool.task_update.name": "更新任务",
    "settings.builtinTool.task_update.desc": "按稳定任务 ID 更新状态和内容",
    "settings.builtinTool.task_list.name": "读取任务",
    "settings.builtinTool.task_list.desc": "读取当前运行的权威任务列表",
    "settings.builtinTool.tool_search.name": "工具搜索",
    "settings.builtinTool.tool_search.desc": "在大型 MCP 工具集中按需检索并激活工具",
    "settings.builtinTool.exit_plan_mode.name": "提交计划",
    "settings.builtinTool.exit_plan_mode.desc": "在计划模式中提交方案并等待批准或修改",
    ...
    "settings.builtinTool.browser_use.name": "内置浏览器",
    "settings.builtinTool.browser_use.desc": "让智能体操作与用户共享的 WebView 浏览器",
    "settings.builtinTool.browser_use.detail":
      "在 PC、Android 和 iOS 上通过同一套结构化动作打开网页、读取内容、点击、输入、滚动和截图。智能体与用户共享标签页和会话，不依赖额外浏览器扩展。",
    ...
    "settings.providerNameRequired": "请输入供应商名称",
    "settings.providerAuthMethod": "认证方式",
    "settings.providerAuthApiKey": "API Key",
    "settings.providerAuthOAuth": "OpenAI 登录",
    "settings.providerAuthToken": "手动令牌",
    "settings.providerOAuthManagedHintCodex":
      "使用 OpenAI 官方登录。访问令牌和刷新令牌只保存在本机加密凭据库中，由 XGent 代理按需刷新。",
    "settings.providerOAuthAccounts": "OpenAI 账户",
    "settings.providerOAuthSelectedAccount": "已选择账户",
    "settings.providerOAuthManageInApp": "请在 XGent 客户端中登录或管理 OpenAI 账户。",
    "settings.providerOAuthOpenAIAccount": "OpenAI 账户",
    "settings.providerOAuthRemoveAccount": "移除账户",
    "settings.providerOAuthNoAccounts": "尚未登录 OpenAI 账户。",
    "settings.providerOAuthWaiting": "在浏览器中完成登录",
    "settings.providerOAuthCopyCode": "复制授权码",
    "settings.providerOAuthWaitingHint": "正在等待 OpenAI 确认，无需手动刷新。",
    "settings.providerOAuthAddAccount": "登录 OpenAI 账户",
    "settings.loading": "加载中",
    "settings.providerOAuthToken": "OAuth Access Token",
    "settings.providerOAuthHintAnthropic":
      "支持 Claude OAuth 访问令牌（sk-ant-oat）。令牌与 API Key 一样存入本机安全凭据存储。",
    "settings.providerOAuthHintCodex":
      "支持 OpenAI/Codex OAuth Access Token。ChatGPT 订阅端点通常还需要账户 ID。",
    "settings.providerOAuthAccountId": "ChatGPT Account ID",
    "settings.providerOAuthAccountIdPlaceholder": "可选账户 ID",
    "settings.providerOAuthAccountIdHint":
      "使用 ChatGPT Codex 订阅端点时填写；标准 OpenAI API 或不要求该请求头的兼容端点可留空。",
    ...
    "settings.providerStreamRetryDesc": "连接中断且尚未输出内容时，按此策略自动重连。",
    "settings.providerStreamRetryDefault": "默认（重试 5 次）",
    ...
    "settings.closeCustomSettings": "返回供应商配置",
    ...
    "settings.commitMessageModel": "提交信息生成模型",
    "settings.retryError": "错误重试",
    "settings.retryErrorDesc": "配置哪些临时上游错误可以安全地重新发起模型请求。",
    "settings.retryErrorPresets": "预设状态码",
    "settings.retryErrorBuiltinNote": "Cloudflare 临时错误默认启用；不会替代供应商自身的重试策略。",
    ...
    "settings.retryErrorCustomPatternsDesc": "大小写不敏感；错误信息包含任一关键词时重试。",
    ...
    "settings.sshDescription": "说明",
    "settings.sshDescriptionPlaceholder": "用途、环境或连接备注（可选）",
    ...
    "settings.sshProxyOptionalHint": "留空时直接连接；支持 SOCKS5 与 HTTP CONNECT 代理。",
    ...
    "settings.accessTitle": "本地与云",
    "settings.accessDesc": "在局域网共享同一个本地 Agent，并配置移动端与云端执行后端",
    "settings.accessLanControl": "连接局域网电脑",
    "settings.accessLanControlHint":
      "在移动端打开电脑提供的同一套 XGent 界面，复杂任务、文件和工具调用都由电脑执行。",
    "settings.accessComputerAddress": "电脑 Web UI 地址",
    "settings.accessLanPairingCode": "电脑配对码",
    "settings.accessLanDeviceName": "设备名称",
    "settings.accessPairComputer": "配对电脑",
    "settings.accessDisconnectComputer": "断开",
    "settings.accessComputerPaired": "已安全配对，可以委托电脑执行",
    "settings.accessComputerNotPaired": "尚未配对当前电脑",
    "settings.accessCheckComputer": "检查连接",
    "settings.accessPreferLanPc": "优先由局域网电脑执行",
    "settings.accessPreferLanPcHint":
      "仅在开启后，移动端才会把支持的复杂工具任务交给已配对的电脑；电脑不可用时继续使用本机移动端环境。",
    "settings.accessOpenComputer": "打开电脑控制界面",
    "settings.accessConnecting": "正在连接…",
    ...
    "settings.accessAllowBrowserAutomationHint":
      "配对设备上的智能体可操作电脑端内置浏览器；不授予终端权限",
    "settings.accessAllowSsh": "允许 SSH",
    "settings.accessAllowSshHint": "配对设备可使用本机保存的 SSH 主机配置",
    "settings.accessAllowGit": "允许 Git 写操作",
    "settings.accessAllowGitHint": "配对设备可暂存、提交、切换分支及同步仓库",
    "settings.accessAllowFileWrite": "允许文件写入",
    ...
    "settings.accessTokenConfigured": "GitHub Token 已配置",
    "settings.accessTokenMissing": "GitHub Token 未配置",
    "settings.accessGithubToken": "Fine-grained GitHub Personal Access Token",
    "settings.accessSaveToken": "安全保存",
    "settings.accessRemoveToken": "移除",
    "settings.accessTokenOwner": "凭据所属：{username}",
    "settings.accessVaultHint":
      "输入 GitHub 用户名和 PAT 后即可生效；凭据使用设备密钥和 Stronghold 加密保存，不会发送给 Web UI 或写入任务仓库。",
    ...
    "settings.mobileNotInstalled": "未安装",
    "settings.mobileRefresh": "刷新状态",
    ...
    "settings.mobileInstallCancelled": "能力包安装已取消",
    ...
    "mcpHub.mobileNetworkOnly": "移动端 MCP 使用 HTTP 或 SSE；本地 stdio 子进程仅桌面端可用。",
    ...
    "settings.skillsLocalImport": "选择本地文件夹",
    "settings.skillsLocalImportTooMany": "本地技能文件过多，最多支持 {count} 个文件。",
    "settings.skillsLocalImportTooLarge": "本地技能文件夹过大，最大支持 {size} MiB。",
    ...
    "settings.skillsStoreSortTrending": "趋势热门",
  ...
  "en-US": {
    ...
    "browser.startBrowsingDescription": "Enter a URL to open a page",
    "chat.suggestBuildTitle": "Build a feature, app or tool",
    "chat.suggestBuildPrompt": "Help me build a feature, app or tool: ",

    "chat.trajectory.open": "Open visual trajectory",
    "chat.trajectory.backToChat": "Back to conversation",
    "chat.trajectory.title": "Conversation trajectory",
    "chat.trajectory.summary": "{events} events \u00b7 {segments} conversation segments",
    "chat.trajectory.refresh": "Refresh trajectory",
    ...
    "chat.trajectory.overview": "Overview",
    "chat.trajectory.input": "Input",
    "chat.trajectory.systemPrompt": "System prompt",
    "chat.trajectory.tools": "Tools",
    "chat.trajectory.usage": "Usage",
    "chat.trajectory.diff": "Prompt changes",
    "chat.trajectory.subagents": "Subagents",
    "chat.trajectory.subagentsLoading": "Loading subagent trajectory\u2026",
    "chat.trajectory.subagentsFailed": "Could not load subagent trajectory",
    "chat.trajectory.started": "Started",
    "chat.trajectory.duration": "Duration",
    "chat.trajectory.turnLabel": "Turn",
    "chat.trajectory.stepLabel": "Step",
    "chat.trajectory.search": "Search events, tools, or models",
    "chat.trajectory.scale": "Timeline scale",
    "chat.trajectory.actualTime": "Actual time",
    "chat.trajectory.sequence": "Sequence",
    "chat.trajectory.view": "Trajectory view",
    "chat.trajectory.timelineView": "Timeline",
    "chat.trajectory.tableView": "Table",
    "chat.trajectory.eventColumn": "Event",
    "chat.trajectory.typeColumn": "Type",
    "chat.trajectory.collapseTurns": "Collapse all turns",
    "chat.trajectory.expandTurns": "Expand all turns",
    "chat.trajectory.legend": "Trajectory type legend",
    "chat.trajectory.noMatches": "No matching trajectory events",
    "chat.trajectory.clearSearch": "Clear search",
    "chat.trajectory.lane.user": "User",
    "chat.trajectory.lane.context": "Context",
    "chat.trajectory.lane.model": "Model",
    "chat.trajectory.lane.tool": "Tool",
    "chat.trajectory.lane.transport": "Transport",
    "chat.trajectory.lane.warning": "Retry / failover",
    "chat.trajectory.lane.compaction": "Compaction",
    "chat.trajectory.lane.system": "System",
    "chat.trajectory.event.user": "User input",
    "chat.trajectory.event.context": "Context injection",
    "chat.trajectory.event.header": "Request context",
    "chat.trajectory.event.step_start": "Model request started",
    "chat.trajectory.event.first_token": "First token received",
    "chat.trajectory.event.step_end": "Model request finished",
    "chat.trajectory.event.retry": "Request retry",
    "chat.trajectory.event.failover": "Provider failover",
    "chat.trajectory.event.transport": "Transport route",
    "chat.trajectory.event.model_request": "Raw model request",
    "chat.trajectory.event.model_response": "Raw model response",
    "chat.trajectory.event.model_result": "Model response result",
    "chat.trajectory.event.model_error": "Model request error",
    "chat.trajectory.event.tool_start": "Tool started",
    "chat.trajectory.event.tool_end": "Tool finished",
    "chat.trajectory.event.compaction_start": "Context compaction started",
    "chat.trajectory.event.compaction_end": "Context compaction finished",
    "chat.trajectory.event.turn_end": "Turn finished",
    ...
    "appUpdate.restartToComplete": "Update installed; restart to finish",
    "appUpdate.updateTo": "Update to v{version}",
    "appUpdate.failedRetry": "Update failed: {message}. Click to retry.",
    "appUpdate.runningTasksTitle": "Conversations are still running",
    "appUpdate.runningTasksDescription":
      "{count} conversation(s) are still running and will be interrupted by a restart.",
    ...
    "chat.workspaceGroupCreate": "New workspace group",
    "chat.workspaceGroupName": "Group name",
    "chat.workspaceGroupMore": "More group actions",
    "chat.workspaceGroupRename": "Rename group",
    "chat.workspaceGroupDelete": "Delete group",
    "chat.workspaceGroupSave": "Save group",
    "chat.workspaceMoveToGroup": "Move to group",
    ...
    "chat.conversationOpenInSplit": "Open in split view",
    "chat.conversationMove": "Move to workspace",
    ...
    "chat.split.toolbar": "Split conversation",
    "chat.split.paneLabel": "Split conversation: {title}",
    "chat.split.continueHere": "Continue here",
    "chat.split.close": "Close split view",
    "chat.split.resize": "Resize split view",
    "chat.split.loading": "Loading conversation",
    "chat.split.loadFailed": "Could not load split conversation",
    "chat.split.retry": "Retry",
    "chat.split.empty": "This conversation has no messages yet",
    "chat.delete": "Delete",
    "chat.remove": "Remove",
    ...
    "chat.history.search": "Search conversation history",
    "chat.history.searchPlaceholder": "Search titles and messages",
    "chat.history.searchClear": "Clear search",
    "chat.history.searching": "Searching…",
    "chat.history.searchEmpty": "No matching history found",
    "chat.history.searchFailed": "Failed to search conversation history",
    "chat.history.select": "Select conversation",
    "chat.history.selectedCount": "{count} selected",
    "chat.history.moveSelected": "Move selected conversations",
    "chat.history.deleteSelected": "Delete selected conversations",
    "chat.history.confirmDeleteSelected": "Click again to confirm deletion",
    "chat.history.cancelSelection": "Exit selection",
    ...
    "chat.history.moveFailed": "Failed to move conversation",
    ...
    "chat.resizeAuxiliaryPanel": "Resize right workspace",
    ...
    "chat.greetingSubtitle": "What should we build?",
    ...
    "chat.suggestIdeateTitle": "Review code and suggest changes",
    ...
    "settings.providerRuntimeReset": "Reset configuration",
    "settings.providerRuntimeResetTitle": "Reset provider runtime configuration?",
    "settings.providerRuntimeResetDescription":
      "This disables failover, clears fallback queues, and restores stream retry, error retry, and usage-query defaults. Providers, API credentials, and models are kept.",
    "settings.providerRuntimeResetConfirm": "Reset runtime configuration",
    ...
    "settings.projectRoots.pick": "Choose a folder to grant",
    "settings.projectRoots.empty": "No additional folders are granted to this project.",
    "settings.projectRoots.noProjects": "Add a local project first.",
    "settings.projectRoots.path": "Folder path",
    "settings.projectRoots.alias": "Tool alias",
    "settings.projectRoots.read": "Read only",
    "settings.projectRoots.write": "Read and write",
    "settings.projectRoots.remove": "Remove folder",
    "settings.projectRoots.revoke": "Revoke all",
    ...
    "settings.projectRoots.skills": "Skills",
    "settings.projectRoots.mcp": "MCP servers",
    "settings.projectRoots.resourcesEmpty": "No resources available",
    "settings.projectRoots.disabled": "Disabled",
    "chat.manualCompact": "Compact context now",
    "chat.manualCompactTitle": "Compact context",
    "chat.manualCompactDescription":
      "Summarize older conversation content to free context space while preserving the details needed to continue.",
    "chat.manualCompactConfirm": "Compact",
    "chat.manualCompactComplete": "Context compaction complete",
    "chat.manualCompactRejected": "This conversation is busy and cannot be compacted now",
    "chat.manualCompactBelowThreshold": "Context usage is below the manual compaction threshold",
    "chat.manualCompactEmpty": "There are no messages to compact",
    "chat.manualCompactUnavailable": "The current context cannot be compacted",
    "chat.manualCompactFailed": "Context compaction failed",
    "chat.manualCompactCancelled": "Compaction cancelled",
    "chat.planMode.off": "Enter plan mode",
    "chat.planMode.on": "Exit plan mode",
    "chat.planMode.pending": "Waiting for approval or feedback",
    ...
    "chat.tasks.todo": "To-do",
    "chat.tasks.completed": "Tasks completed",
    "chat.tasks.progress": "Task completion progress",
    "chat.tasks.close": "Close task plan",
    ...
    "chat.activity.edited": "Edited {count} files",
    "chat.activity.read": "Read {count} files",
    "chat.activity.commands": "Commands run",
    "chat.activity.tools": "Tools used",
    "chat.activity.title": "Xgent’s computer",
    ...
    "chat.inputHint": "Type a message, add files from +, and queue prompts...",
    "chat.inputHintWithSkills": "Type a message, add files and Skills from +, and queue prompts...",
    "chat.changedFiles.title": "Edited {count} files",
    "chat.changedFiles.titleOne": "Edited 1 file",
    "chat.changedFiles.undo": "Undo",
    "chat.cloudArtifacts.inline": "Available files:",
    ...
    "chat.cloudArtifacts.title": "Cloud artifacts ({count})",
    "chat.cloudArtifacts.titleOne": "Cloud artifact",
    "chat.cloudArtifacts.hint":
      "Select to preview or edit in the app; other file types open in the file manager",
    "chat.cloudArtifacts.open": "Open artifact",
    "chat.cloudArtifacts.reveal": "Reveal artifact in folder",
    ...
    "chat.cancel": "Cancel",
    "chat.toolApproval.title": "{count} actions need approval",
    "chat.toolApproval.approve": "Allow",
    "chat.toolApproval.approveSession": "Allow for session",
    "chat.toolApproval.deny": "Deny",
    "chat.toolApproval.approveAll": "Allow all",
    "chat.toolApproval.denyAll": "Deny all",
    "chat.toolApproval.failed": "Failed to submit the tool approval decision",
    ...
    "chat.composer.voiceNotConfigured": "Enable and configure a speech provider in Settings first",
    ...
    "chat.upload.add": "Add",
    "chat.upload.filesAndPhotos": "Files or photos",
    "chat.upload.camera": "Camera",
    ...
    "chat.composer.plugins": "Plugins and skills",
    "chat.runtime.thinkHarder": "Think harder",
    "settings.desktopOnly": "This setting is available in the desktop app only",
    "settings.cronHttpMethod": "Request method",
    "settings.thirdPartySync": "Sync from third party",
    "settings.refreshLocalProviderConfigs": "Rescan local configurations",
    ...
    "chat.image.openSystem": "Open in system viewer",
    "chat.image.zoom": "Zoom",
    ...
    "chat.tool.todoPending": "Pending",
    "chat.tool.todoInProgress": "In progress",
    "chat.tool.todoCompleted": "Completed",
    "chat.tool.expandActivity": "Expand tool activity",
    "chat.tool.collapseActivity": "Collapse tool activity",
    "chat.tool.name.agent": "Sub-agent",
    "chat.tool.name.askUser": "Ask user",
    "chat.tool.name.bash": "Terminal command",
    "chat.tool.name.cron": "Scheduled tasks",
    "chat.tool.name.delete": "Delete file",
    "chat.tool.name.edit": "Edit file",
    "chat.tool.name.glob": "Find files",
    "chat.tool.name.grep": "Search content",
    "chat.tool.name.image": "View image",
    "chat.tool.name.list": "List directory",
    "chat.tool.name.process": "Background process",
    "chat.tool.name.mcp": "MCP manager",
    "chat.tool.name.memory": "Memory manager",
    "chat.tool.name.read": "Read file",
    "chat.tool.name.sendMessage": "Send message",
    "chat.tool.name.skills": "Skills manager",
    "chat.tool.name.ssh": "SSH manager",
    "chat.tool.name.todo": "Task list",
    "chat.tool.name.write": "Write file",
    "chat.tool.action.add": "Add",
    "chat.tool.action.create": "Create",
    "chat.tool.action.delete": "Delete",
    "chat.tool.action.disable": "Disable",
    "chat.tool.action.enable": "Enable",
    "chat.tool.action.get": "View",
    "chat.tool.action.list": "List",
    "chat.tool.action.read": "Read",
    "chat.tool.action.remove": "Remove",
    "chat.tool.action.run": "Run",
    "chat.tool.action.update": "Update",
    "chat.askUser.question": "Question",
    "chat.askUser.recommended": "Recommended",
    "chat.askUser.other": "Other",
    "chat.askUser.otherPlaceholder": "Type your answer",
    "chat.askUser.cancelled": "Cancelled",
    "chat.askUser.timedOut": "Timed out; recommended options were used",
    "chat.askUser.answered": "Answered",
    "chat.askUser.submit": "Submit answers",
    "chat.askUser.submitting": "Submitting",
    "chat.askUser.submitFailed": "Failed to submit answers",
    ...
    "sidebar.mobile.library": "Library",
    "sidebar.mobile.projects": "Projects",
    "sidebar.mobile.plugins": "Plugins",
    "sidebar.mobile.scheduled": "Scheduled",
    "sidebar.mobile.remote": "Remote",
    "sidebar.mobile.more": "More",
    "sidebar.mobile.searchPlugins": "Search plugins",
    "sidebar.soul": "Soul persona",
    "sidebar.soulMenu": "Open Soul and workspace tools",
    "sidebar.soulPresets": "Persona presets",
    "sidebar.addSoul": "New persona",
    "sidebar.terminal": "Terminal",
    "sidebar.defaultTerminal": "Default terminal",
    "sidebar.gitReview": "Git Review",
    "sidebar.sshConnection": "SSH Connection",
    "sidebar.backgroundTasks": "Background Tasks",
    ...
    "projectTools.noProjectSelected": "Select a workspace first",
    ...
    "projectTools.bgTaskRunning": "Running",
    ...
    "projectTools.bgTaskRetry": "Retry",
    ...
    "projectTools.sshConnectionTitle": "SSH Connection",
    "projectTools.newSshConnection": "New SSH Connection",
    "projectTools.sshConnectionDescription":
      "Start interactive SSH terminals and associate project hosts",
    "projectTools.sshConnectionSettings": "SSH host settings",
    "projectTools.sshConnectionBack": "Back to SSH",
    "projectTools.sshConnectionScopeGroup": "Switch SSH connection scope",
    "projectTools.sshConnectionScopeProject": "Project SSH",
    "projectTools.sshConnectionScopeAll": "Global SSH",
    "projectTools.sshConnectionConfiguredHosts": "{count} SSH hosts associated",
    "projectTools.sshConnectionNoProject": "Select a project to associate SSH hosts",
    "projectTools.sshConnectionProjectEmpty": "No SSH connections for this project",
    "projectTools.sshConnectionProjectEmptyHint":
      "Associate SSH hosts from settings first, then start an interactive terminal here.",
    "projectTools.sshConnectionProjectEmptyWithHosts":
      "Select an associated host to start an SSH terminal.",
    "projectTools.sshConnectionAllEmpty": "No SSH connections running",
    "projectTools.sshConnectionAllEmptyHint": "There are no running SSH terminals.",
    "projectTools.sshConnectionAssociateHosts": "Associate SSH Hosts",
    "projectTools.sshConnectionAssociateHostsHint":
      "Choose hosts configured in Settings > SSH for the current project",
    "projectTools.sshConnectionAssociatedCount": "associated",
    "projectTools.sshConnectionNoConfiguredHosts": "No SSH hosts configured yet",
    "projectTools.sshConnectionNoConfiguredHostsHint":
    ...
    "projectTools.sshConnectionSftpEnabled": "SFTP feature",
    "projectTools.sshConnectionNote": "Note",
    ...
    "projectTools.sshConnectionConnected": "Connected",
    "projectTools.sshConnectionReconnecting": "Reconnecting {attempt}/{max}",
    "projectTools.sshConnectionDisconnected": "Disconnected",
    "projectTools.sshConnectionLatencyUnknown": "Latency --",
    "projectTools.sshConnectionLatencyChecking": "Checking latency",
    "projectTools.sshConnectionLatencyValue": "Latency {ms}ms",
    "projectTools.sshConnectionOpenBash": "Open Bash",
    "projectTools.sshConnectionOpenSftp": "Open SFTP file manager",
    "projectTools.sshConnectionPromptTitle": "Confirm SSH host key",
    "projectTools.sshConnectionAuthPromptTitle": "SSH authentication",
    "projectTools.sshConnectionTrustHost": "Trust and connect",
    "projectTools.sshConnectionRejectHost": "Cancel",
    "projectTools.sshConnectionPromptCancel": "Cancel",
    "projectTools.sshConnectionPromptSubmit": "Continue",
    "projectTools.sshConnectionFingerprint": "Fingerprint",
    "projectTools.sshConnectionKeyType": "Key type",
    ...
    "projectTools.closeSshConnectionTab": "Close SSH Connection",
    ...
    "projectTools.gitReview.worktrees": "Git Worktrees",
    "projectTools.gitReview.manageWorktrees": "Manage worktrees",
    "projectTools.gitReview.createWorktree": "Create worktree",
    "projectTools.gitReview.worktreeBranch": "New branch name",
    "projectTools.gitReview.worktreeDirectory": "Directory name",
    "projectTools.gitReview.worktreeStartPoint": "Start point (defaults to HEAD)",
    "projectTools.gitReview.worktreeParent": "Parent directory (app storage by default)",
    "projectTools.gitReview.noWorktrees": "This repository has no linked worktrees",
    "projectTools.gitReview.deleteWorktreeBranch": "Also delete the merged branch",
    "projectTools.gitReview.forceRemoveWorktree": "Force removal with uncommitted changes",
    ...
    "git.branchSelector.back": "Back to Git repository",
    "git.branchSelector.loading": "Refreshing repository status",
    ...
    "projectTools.gitReview.initSuccessMessage": "Git repository initialized.",
    ...
    "projectTools.resizePanelWidth": "Resize tool panel",
    ...
    "projectTools.fileTree.importFile": "Import Files",
    "projectTools.fileTree.importTooLarge": "{file} exceeds the 20 MB file limit",
    ...
    "projectTools.fileTree.openExternal": "Open with",
    ...
    "workspaceSshTerminal.sftpTab": "SFTP",
    "workspaceSshTerminal.localForward": "SSH local port forwarding",
    "workspaceSshTerminal.forwardRemoteHost": "Remote host",
    "workspaceSshTerminal.forwardRemotePort": "Remote port",
    "workspaceSshTerminal.forwardLocalPort": "Local port",
    ...
    "workspaceEditor.run": "Run",
    "workspaceEditor.running": "Running...",
    "workspaceEditor.runOutput": "Run output",
    "workspaceEditor.runSucceeded": "Run complete",
    "workspaceEditor.runFailed": "Run failed",
    "workspaceEditor.exitCode": "Exit code",
    "workspaceEditor.noRunOutput": "The command produced no output.",
    "workspaceEditor.closeRunOutput": "Close",
    "workspaceEditor.moreActions": "More editor actions",
    ...
    "workspaceFilePreview.preview": "Preview",
    "workspaceFilePreview.source": "Source",
    "workspaceFilePreview.copySource": "Copy source",
    "workspaceFilePreview.copied": "Copied",
    "workspaceFilePreview.copyFailed": "Copy failed",
    "workspaceFilePreview.openExternal": "Open with",
    ...
    "workspaceFilePreview.maximize": "Maximize in chat area",
    "workspaceFilePreview.restoreSidePanel": "Restore side preview",
    ...
    "settings.navToolPermissions": "Tool Permissions",
    ...
    "settings.commandSafety.askDesc": "Request confirmation before every state-changing command.",
    ...
    "settings.stt.test.connected": "Connection succeeded",
    "settings.stt.test.connected_no_speech": "Connected (no speech detected in the test audio)",
    "settings.stt.test.timeout": "Connection timed out",
    "settings.stt.test.authentication_failed": "Authentication failed",
    ...
    "settings.usage.mode.general": "General balance script",
    "settings.usage.mode.newapi": "NewAPI",
    "settings.usage.mode.custom": "Custom script",
    "settings.usage.timeout": "Timeout (seconds)",
    "settings.usage.baseUrl": "Query Base URL (blank uses provider)",
    "settings.usage.secretSaved": "Stored securely",
    ...
    "settings.usage.saveBeforeTest": "Save the provider before testing its usage query.",
    "settings.usage.testSuccess": "Query succeeded with {count} usage records.",
    ...
    "settings.toolPolicyAllowDesc": "Allow: run directly",
    ...
    "settings.shortcutToggleDesc": "Toggle between shown and hidden",
    "settings.shortcutNewChat": "New chat",
    "settings.shortcutNewChatDesc": "Open the window and start a new chat",
    "settings.shortcutPin": "Toggle pin",
    "settings.shortcutPinDesc": "Toggle always-on-top mode",
    "settings.shortcutNotSet": "Not set",
    "settings.shortcutSet": "Set shortcut",
    "settings.shortcutChange": "Change shortcut",
    "settings.shortcutClear": "Clear shortcut",
    "settings.shortcutToggleOnOff": "Enable or disable shortcut",
    "settings.shortcutPressEnter": "Press Enter to save",
    "settings.shortcutRecordingHint": "Press modifiers and one main key",
    "settings.shortcutNeedMainKey": "A shortcut needs a non-modifier key",
    "settings.shortcutConflict": "This shortcut is already assigned",
    "settings.shortcutOccupied": "The shortcut is reserved by the system or another app",
    "settings.shortcutRegisterFailed": "Some shortcuts could not be registered",
    "settings.shortcutSaved": "Shortcuts saved",
    "settings.shortcutRestoreDefaults": "Restore defaults",
    "settings.shortcutKeyboardTitle": "Keyboard layout preview",
    "settings.shortcutLayout61": "61 keys",
    "settings.shortcutLayout87": "87 keys",
    "settings.shortcutLayout104": "104 keys",
    "settings.backupLocalTitle": "Local backup",
    "settings.backupLocalDesc": "Export or import settings, services, and skills",
    "settings.backupExport": "Export backup",
    "settings.backupImport": "Import backup",
    "settings.backupExportDone": "Backup exported",
    "settings.backupExportFailed": "Failed to export backup",
    "settings.backupImportDone": "Backup imported",
    "settings.backupImportFailed": "Failed to import backup",
    "settings.backupImportConfirmTitle": "Import this backup?",
    "settings.backupImportConfirmSubtitle": "Current settings will be updated from the backup",
    "settings.backupImportConfirmAction": "Import",
    "settings.backupCancel": "Cancel",
    "settings.backupScopeTitle": "Backup contents",
    "settings.backupScopeDesc": "Sensitive credentials follow the secure storage policy",
    ...
    "settings.backupSourceTime": "Created",
    "settings.backupSourceVersion": "App version",
    "settings.backupSyncTitle": "WebDAV sync",
    "settings.backupSyncDesc": "Sync encrypted backups through your own WebDAV storage",
    "settings.backupSyncPreset": "Service preset",
    ...
    "settings.backupSyncPasswordSaved": "Password is stored securely; leave blank to keep it",
    "settings.backupSyncRemoteDir": "Remote directory",
    "settings.backupSyncProfile": "Profile",
    "settings.backupSyncProfileHint": "Use the same profile on devices that share a backup",
    "settings.backupSyncAuto": "Automatic sync",
    "settings.backupSyncAutoHint": "Upload changes automatically after a debounce",
    "settings.backupAutoBackupHint": "The connection is saved and tested before enabling",
    "settings.backupSyncSave": "Save",
    "settings.backupSyncTest": "Test connection",
    "settings.backupSyncUpload": "Upload",
    "settings.backupSyncDownload": "Download and apply",
    "settings.backupSyncDirtyHint": "Local settings have changes not yet uploaded",
    "settings.backupSyncLastAt": "Last sync: {time}",
    "settings.backupSyncRemoteEmpty": "No remote backup exists yet",
    "settings.backupSyncSaveDone": "Sync settings saved",
    "settings.backupSyncSaveFailed": "Failed to save sync settings",
    "settings.backupSyncTestDone": "Connection test succeeded",
    "settings.backupSyncTestFailed": "Connection test failed",
    "settings.backupSyncSaveAndTestDone": "Settings saved and connection verified",
    "settings.backupSyncSaveAndTestFailed": "Settings saved, but connection test failed",
    "settings.backupSyncUploadDone": "Backup uploaded",
    "settings.backupSyncUploadFailed": "Failed to upload backup",
    "settings.backupSyncDownloadDone": "Remote backup applied",
    "settings.backupSyncDownloadFailed": "Failed to download backup",
    "settings.backupSyncUploadConfirmTitle": "Upload the current backup?",
    "settings.backupSyncUploadConfirmSubtitle": "The matching remote backup will be updated",
    "settings.backupSyncDownloadConfirmTitle": "Apply the remote backup?",
    "settings.backupSyncDownloadConfirmSubtitle": "Current settings will be updated from remote",
    "settings.backupSyncAutoConfirmTitle": "Enable automatic sync?",
    "settings.backupSyncAutoConfirmSubtitle": "Future setting changes will upload automatically",
    "settings.backupSyncAutoConfirmDesc": "The profile will be saved and verified first.",
    "settings.backupSyncAutoConfirmAction": "Enable",
    "settings.backupSyncAutoDone": "Automatic sync enabled",
    "settings.backupSyncAutoErrorTitle": "Could not enable automatic sync",
    "settings.navSystem": "System",
    "settings.navSystemTools": "System Tools",
    "settings.navProviders": "Providers",
    "settings.navSoul": "Soul",
    "settings.navHooks": "Hooks",
    "settings.navOther": "Other",
    "settings.mobile.otherDescription":
      "Manage hooks, scheduled tasks, and SSH connections in one place",
    "settings.navAgents": "Prompt",
    "settings.navSsh": "SSH",
    "settings.navCron": "Cron",
    "settings.navRemote": "Remote",
    "settings.navAccess": "Local & Cloud",
    "settings.navMobileExecution": "Shell Management",
    "settings.navMobileAssistant": "Personal Assistant",
    "settings.navSkills": "Skills",
    ...
    "settings.mobile.backToSettings": "Back to Settings",
    "settings.mobile.appearanceGroup": "Appearance and models",
    "settings.mobile.personalGroup": "Personalization",
    "settings.mobile.capabilitiesGroup": "Capabilities and connections",
    "settings.mobile.systemDescription": "Appearance, language, workspace, and runtime preferences",
    "settings.mobile.providersDescription": "Model providers, OAuth, and model selection",
    "settings.mobile.soulDescription": "Name, personality, voice, and response language",
    "settings.mobile.agentsDescription": "Global instructions and agent behavior",
    "settings.mobile.memoryDescription": "Long-term memory, project memory, and organization",
    "settings.mobile.skillsDescription": "Manage installed skills, the store, and local imports",
    "settings.mobile.mcpDescription": "Manage MCP servers, the registry, and local imports",
    "settings.mobile.systemToolsDescription": "Local execution tools and safety policies",
    "settings.mobile.hooksDescription": "Run actions automatically when important events occur",
    "settings.mobile.cronDescription": "Run agent tasks on a schedule",
    "settings.mobile.sshDescription": "Remote hosts and terminal connections",
    "settings.mobile.accessDescription": "Connect to a LAN computer and configure cloud execution",
    "settings.mobile.executionDescription": "Initialize and manage the Shell environment",
    "settings.mobile.assistantDescription": "Voice input, system permissions, and device services",
    "settings.native.back": "Back",
    "settings.native.shellTitle": "Shell Management",
    "settings.native.shellEnvironment": "Shell environment",
    "settings.native.shellInstalling": "Installing Shell environment",
    "settings.native.shellInstallingEssentials": "Installing Bash and Linux essentials",
    "settings.native.shellEssentialsError":
      "Alpine is installed and usable offline, but Bash and Linux essentials need a network connection: {detail}",
    "settings.native.network": "Network",
    "settings.native.cellular": "Cellular",
    "settings.native.ethernet": "Ethernet",
    "settings.native.offline": "Offline",
    "settings.native.otherNetwork": "Other network",
    "settings.native.unavailable": "Unavailable",
    "settings.native.installed": "Installed",
    "settings.native.notInstalled": "Not installed",
    "settings.native.status": "Status",
    "settings.native.backend": "Backend",
    "settings.native.version": "Version",
    "settings.native.size": "Size",
    "settings.native.actions": "Actions",
    "settings.native.toolchains": "Toolchains",
    "settings.native.ready": "Ready",
    "settings.native.folders": "Folders",
    "settings.native.theme": "Theme",
    "settings.native.appearance": "Appearance",
    "settings.native.system": "System",
    "settings.native.light": "Light",
    "settings.native.dark": "Dark",
    "settings.native.showReasoning": "Show reasoning",
    "settings.native.appSettings": "App settings",
    "settings.native.accessibilityNote":
      "Text size, contrast, and reduced motion follow system accessibility settings.",
    "settings.native.addProvider": "Add provider",
    "settings.native.newProvider": "New provider",
    "settings.native.name": "Name",
    "settings.native.api": "API",
    "settings.native.exactEndpoint": "Use exact endpoint",
    "settings.native.requestFormat": "Request format",
    "settings.native.fetchModels": "Fetch models",
    "settings.native.enabledModels": "Enabled models",
    "settings.native.addModel": "Add model",
    "settings.native.add": "Add",
    "settings.native.deleteProvider": "Delete this provider?",
    "settings.native.deleteProviderDetail":
      "Its local credentials and model configuration will be removed.",
    "settings.native.organizeMemory": "Automatic memory organization",
    "settings.native.scope": "Scope",
    "settings.native.deleteMcp": "Delete {name}?",
    "settings.native.connectMcp": "Connect MCP server",
    "settings.native.transport": "Transport",
    "settings.native.command": "Command",
    "settings.native.arguments": "Arguments (one per line)",
    "settings.native.connect": "Connect",
    "settings.native.speechChecking": "Checking system speech recognition",
    "settings.native.speechAvailable": "System speech recognition is available",
    "settings.native.speechUnavailable": "System speech recognition is unavailable",
    "settings.native.aliyun": "Aliyun DashScope",
    "settings.native.tencent": "Tencent Cloud ASR",
    "settings.native.volcengineV2": "Volcengine ASR v2",
    "settings.native.volcengineV3": "Volcengine Seed ASR v3",
    ...
    "settings.mobileAssistant.remindersDescription": "Allow the assistant to work with reminders.",
    "settings.mobileAssistant.photos": "Photos",
    "settings.mobileAssistant.photosDescription":
      "Select photos as task input or generated output.",
    ...
    "settings.mobileAssistant.granted": "Allowed",
    "settings.mobileAssistant.denied": "Denied",
    "settings.mobileAssistant.requested": "Authorization requested",
    "settings.mobileAssistant.notRequested": "Tap to allow",
    "settings.mobileAssistant.platformServices": "Platform services",
    "settings.mobileAssistant.icloud": "iCloud sync",
    "settings.mobileAssistant.icloudDescription": "Sync XGent settings and workspace metadata.",
    "settings.mobileAssistant.externalFolders": "Mount external folders",
    "settings.mobileAssistant.externalFoldersDescription":
      "Securely expose a folder selected by the system picker to a task workspace.",
    "settings.mobileAssistant.available": "Available",
    "settings.mobileAssistant.unavailable": "Not enabled yet",
    "settings.mobile.aboutDescription": "Version, updates, and application information",
    "settings.soulTitle": "Soul",
    "settings.soulPresetsGroup": "Persona presets",
    "settings.soulAddPreset": "New persona",
    "settings.soulCreateDraftHint":
      "This is an unsaved draft. The persona is created and activated only after you save it.",
    ...
    "settings.soulDeletePresetConfirm":
      "This persona cannot be recovered after deletion. Other personas are not affected.",
    ...
    "settings.soulNameHint": "Shown in the sidebar and assistant identity",
    "settings.soulLanguage": "Default language",
    "settings.soulLanguageHint": "Auto follows the language used by the user",
    "settings.soulLanguageAuto": "Auto",
    "settings.soulStyle": "Response style",
    ...
    "settings.soulSaved": "SOUL.md saved. It will apply to the next task.",
    "settings.soulReload": "Reload",
    "settings.soulLoading": "Loading SOUL.md",
    "chat.mobileActivity.title": "Task Activity",
    "chat.mobileActivity.live": "Live",
    "chat.mobileActivity.working": "Working",
    "chat.mobileActivity.running": "The agent is using a tool",
    "chat.mobileActivity.awaitingResult": "No execution result received yet",
    "chat.mobileActivity.recent": "Tool activity in this conversation",
    "chat.mobileActivity.close": "Close task activity",
    "chat.mobileActivity.empty": "No task activity yet",
    "chat.mobileActivity.emptyDescription":
      "Shell, browser, and other tool activity will appear here while the agent works.",
    "chat.mobileActivity.noArguments": "No arguments",
    "chat.mobileActivity.input": "Input",
    "chat.mobileActivity.output": "Output",
    "chat.mobileActivity.round": "Round {round}",
    "chat.mobileMenu.title": "Workspace tools",
    "chat.mobileMenu.terminal": "Open terminal",
    "chat.mobileMenu.rootfs": "Shell management",
    "chat.mobileMenu.browser": "Open browser",
    "chat.mobileMenu.browserSettings": "Browser settings",
    "chat.mobileMenu.gitReview": "Git review",
    "chat.mobileMenu.ssh": "SSH connection",
    "chat.mobileMenu.background": "Background tasks",
    "chat.mobileTerminal.title": "Mobile terminal",
    "chat.mobileTerminal.clear": "Clear terminal history",
    "chat.mobileTerminal.close": "Close mobile terminal",
    "chat.mobileTerminal.ready": "Terminal connected to the current workspace",
    "chat.mobileTerminal.workspaceHint":
      "Android commands run inside PRoot/Alpine; iOS commands run through the a-Shell frameworks. Generated files are saved in the workspace path above.",
    "chat.mobileTerminal.running": "Command is running",
    "chat.mobileTerminal.exitCode": "Exit code: {code}",
    "chat.mobileTerminal.placeholder": "Enter a command",
    "chat.mobileTerminal.noWorkspace": "Select a workspace first",
    "chat.mobileTerminal.stop": "Stop command",
    "chat.mobileTerminal.run": "Run command",
    "chat.mobileGit.title": "Git review",
    "chat.mobileGit.authorName": "Git author name",
    "chat.mobileGit.authorEmail": "Git author email",
    "chat.mobileGit.ready": "Inspect version control state in this workspace",
    "chat.mobileGit.hint":
      "Review status, changes, and commit history with native Git, without a command-line tool on the device.",
    "chat.mobileGit.status": "Status",
    "chat.mobileGit.changes": "Changes",
    "chat.mobileGit.history": "History",
    "chat.mobileGit.back": "Back to Git list",
    "chat.mobileSsh.title": "SSH connection",
    "chat.mobileSsh.ready": "Connect from a saved host or command",
    "chat.mobileSsh.hint":
      "Selecting a host fills a safe SSH command. Keep keys in a location visible to the mobile shell.",
    "chat.mobileSsh.placeholder": "ssh user@host or a remote command",
    "chat.mobileSsh.savedHosts": "Saved hosts",
    "chat.mobileSsh.back": "Back to hosts",
    "chat.mobileSsh.commandMode": "Remote command mode",
    "chat.mobileSsh.commandHint":
      "Credentials are read only from secure local storage; each command runs independently and remains visible here.",
    "chat.mobileSsh.remoteCommandPlaceholder": "Remote command, for example uname -a",
    "chat.mobileSsh.interactiveUnsupported":
      "Keyboard-interactive authentication is unavailable in mobile command mode",
    "chat.mobileSsh.keyboardResponse": "Keyboard-interactive response",
    "chat.mobileSsh.keyboardResponseHint":
      "Enter the response for this connection, then run a remote command. The response is not saved.",
    "chat.mobileSsh.keyboardResponsePlaceholder": "One-time authentication response",
    "chat.mobileSsh.associated": "Project host",
    "chat.mobileSsh.associateHost": "Associate with current project",
    "chat.mobileSsh.removeAssociation": "Remove project association",
    "chat.mobileWorkspace.new": "New workspace",
    "chat.mobileWorkspace.hint":
      "The workspace is created inside XGent storage. Files generated by the terminal and agent are saved here.",
    "chat.mobileWorkspace.name": "Workspace name",
    "chat.mobileWorkspace.placeholder": "For example: My Python project",
    "chat.mobileWorkspace.create": "Create workspace",
    "chat.mobileWorkspace.creating": "Creating",
    "chat.mobileWorkspace.or": "or",
    "chat.mobileWorkspace.chooseFolder": "Choose a folder on this device",
    "chat.mobileWorkspace.chooseFolderHint":
      "Android persists the SAF grant for PRoot; iOS stores a security-scoped bookmark for a-Shell.",
    "chat.clone.title": "Clone remote repository",
    "chat.clone.newTab": "New folder",
    "chat.clone.cloneTab": "Clone repository",
    "chat.clone.remoteUrl": "Remote repository URL",
    "chat.clone.branch": "Branch (optional)",
    "chat.clone.defaultBranch": "Use default branch",
    "chat.clone.loadBranches": "Load branches",
    "chat.clone.chooseDestination": "Choose destination parent",
    "chat.clone.start": "Start cloning",
    "chat.clone.starting": "Starting",
    "chat.clone.cancel": "Cancel clone",
    "chat.clone.cancelling": "Cancelling",
    "chat.clone.dismiss": "Dismiss clone task",
    "chat.clone.open": "Open workspace",
    "settings.mobileExternalWorkspaces": "External Workspaces",
    "settings.mobileExternalWorkspacesHint":
      "After authorization, the terminal, agent, and My Files share this directory.",
    "settings.mobileMountFolder": "Mount Folder",
    "settings.mobileNoExternalWorkspaces": "No external workspace is mounted",
    "settings.mobileReadWrite": "Read/write",
    "settings.mobileReadOnly": "Read-only",
    "browser.title": "Browser",
    "browser.open": "Open embedded browser",
    ...
    "browser.agentOperating": "The agent is operating this browser session",
    "browser.sharedSession": "You and the agent share this browser session",
    "browser.takeOver": "Take over",
    "browser.finishAssistance": "Finish assisting",
    "browser.assistanceActive":
      "You are in control; the agent will read the updated page and continue when finished",
    "browser.dismissError": "Dismiss",
    "browser.remoteHostTitle": "Browser is running on the computer",
    "browser.remoteHostDescription":
      "This is the LAN Web UI. The agent can still operate the computer's browser; open the desktop client to view the live surface.",
    "browser.homePage": "Home Page",
    "browser.automation": "Agent Automation",
    "browser.privacy": "Privacy & Sessions",
    "browser.clearSessions": "Close and clear all browser sessions",
    ...
    "settings.providerFullUrl": "Full request URL",
    "settings.providerFullUrlDesc":
      "Enable when Base URL already includes the final API endpoint so no request path is appended.",
    ...
    "settings.reorderVerticalHint":
      "Drag to reorder, or use Arrow Up, Arrow Down, Home, and End from the keyboard",
    ...
    "settings.codeFontFamily": "Code & terminal font",
    "settings.fontFamilyDefault": "Built-in default",
    "settings.fontFamilyCustom": "Custom",
    "settings.fontFamilyPlaceholder": "Enter a font family",
    "settings.fontSizeSidebar": "Sidebar",
    "settings.fontSizeChat": "Chat Area",
    "settings.fontSizeWorkspaceTools": "Tools Panel",
    ...
    "settings.providerNameRequired": "Enter a provider name",
    "settings.providerAuthMethod": "Authentication",
    "settings.providerAuthApiKey": "API key",
    "settings.providerAuthOAuth": "OpenAI sign-in",
    "settings.providerAuthToken": "Manual token",
    "settings.providerOAuthManagedHintCodex":
      "Sign in with OpenAI. Access and refresh tokens stay in the encrypted device vault and are refreshed by the XGent proxy.",
    "settings.providerOAuthAccounts": "OpenAI accounts",
    "settings.providerOAuthSelectedAccount": "Selected account",
    "settings.providerOAuthManageInApp":
      "Sign in or manage OpenAI accounts in the native XGent app.",
    "settings.providerOAuthOpenAIAccount": "OpenAI account",
    "settings.providerOAuthRemoveAccount": "Remove account",
    "settings.providerOAuthNoAccounts": "No OpenAI account is signed in.",
    "settings.providerOAuthWaiting": "Finish signing in in your browser",
    "settings.providerOAuthCopyCode": "Copy authorization code",
    "settings.providerOAuthWaitingHint":
      "Waiting for OpenAI confirmation; no manual refresh is needed.",
    "settings.providerOAuthAddAccount": "Sign in to OpenAI",
    "settings.loading": "Loading",
    "settings.providerOAuthToken": "OAuth access token",
    "settings.providerOAuthHintAnthropic":
      "Accepts Claude OAuth access tokens (sk-ant-oat). Tokens use the same local secure credential storage as API keys.",
    "settings.providerOAuthHintCodex":
      "Accepts an OpenAI/Codex OAuth access token. ChatGPT subscription endpoints commonly also require an account ID.",
    "settings.providerOAuthAccountId": "ChatGPT account ID",
    "settings.providerOAuthAccountIdPlaceholder": "Optional account ID",
    "settings.providerOAuthAccountIdHint":
      "Required by ChatGPT Codex subscription endpoints; leave empty for the standard OpenAI API or compatible endpoints that do not require it.",
    "settings.baseUrl": "Base URL",
    "settings.apiKey": "API Key",
    ...
    "settings.providerStreamRetryDesc":
      "Reconnect automatically when the connection fails before any content is produced.",
    "settings.providerStreamRetryDefault": "Default (5 retries)",
    ...
    "settings.providerStreamRetryMaxRetriesDesc":
      "Retries after the initial request fails; the initial request is not counted.",
    ...
    "settings.closeCustomSettings": "Back to provider settings",
    ...
    "settings.retryErrorDesc":
      "Choose which transient upstream errors may safely restart a model request.",
    "settings.retryErrorPresets": "Preset status codes",
    "settings.retryErrorBuiltinNote":
      "Transient Cloudflare errors are enabled by default and complement provider retry policies.",
    ...
    "settings.retryError.presetShort.526": "Bad SSL certificate",
    ...
    "settings.retryErrorCustomPatternsDesc":
      "Case-insensitive substrings; retry when the error contains any keyword.",
    ...
    "settings.sshDescription": "Description",
    "settings.sshDescriptionPlaceholder": "Purpose, environment, or connection notes (optional)",
    "settings.sshHost": "Host",
    ...
    "settings.sshProxyOptionalHint":
      "Leave empty for a direct connection. SOCKS5 and HTTP CONNECT proxies are supported.",
    ...
    /* ── Settings Local Access ── */
    "settings.accessTitle": "Local & Cloud",
    "settings.accessDesc":
      "Share one local Agent on your LAN and configure mobile or cloud execution backends",
    "settings.accessLanControl": "Connect to a LAN computer",
    "settings.accessLanControlHint":
      "Open the same XGent interface served by your computer. Complex tasks, files, and tool calls run on the computer.",
    "settings.accessComputerAddress": "Computer Web UI address",
    "settings.accessLanPairingCode": "Computer pairing code",
    "settings.accessLanDeviceName": "Device name",
    "settings.accessPairComputer": "Pair computer",
    "settings.accessDisconnectComputer": "Disconnect",
    "settings.accessComputerPaired": "Securely paired and ready for delegated execution",
    "settings.accessComputerNotPaired": "The current computer is not paired",
    "settings.accessCheckComputer": "Check connection",
    "settings.accessPreferLanPc": "Prefer LAN computer execution",
    "settings.accessPreferLanPcHint":
      "Only when enabled, route supported complex tool tasks to the paired computer; continue with the mobile environment when it is unavailable.",
    "settings.accessOpenComputer": "Open computer control",
    "settings.accessConnecting": "Connecting…",
    "settings.accessLanPairingHint":
    ...
    "settings.accessAllowBrowserAutomation": "Allow browser automation",
    "settings.accessAllowBrowserAutomationHint":
      "Agents on paired devices may operate this computer's embedded browser without terminal access",
    ...
    "settings.accessTokenConfigured": "GitHub token configured",
    "settings.accessTokenMissing": "GitHub token missing",
    "settings.accessGithubToken": "Fine-grained GitHub Personal Access Token",
    "settings.accessSaveToken": "Save securely",
    "settings.accessRemoveToken": "Remove",
    "settings.accessTokenOwner": "Credential owner: {username}",
    "settings.accessVaultHint":
      "Enter the GitHub username and PAT, then save. A device key and Stronghold encrypt the credential at rest; it is never sent to Web UI or written into task repositories.",
    ...
    "settings.mobileNotInstalled": "Not installed",
    "settings.mobileRefresh": "Refresh status",
    ...
    "settings.mobileInstallCancelled": "Capability pack installation was cancelled",
    ...
    "mcpHub.mobileNetworkOnly":
      "Mobile MCP uses HTTP or SSE; local stdio subprocesses are available on desktop only.",
    "mcpHub.http": "http (Streamable HTTP)",
    "mcpHub.sse": "sse (Legacy HTTP+SSE)",
    "mcpHub.timeout": "Timeout (ms)",
    "mcpHub.command": "Command",
    ...
    "settings.skillsLocalImport": "Choose Local Folder",
    "settings.skillsLocalImportTooMany":
      "The local Skill contains too many files. The maximum is {count}.",
    "settings.skillsLocalImportTooLarge":
      "The local Skill folder is too large. The maximum is {size} MiB.",
    ...
    "settings.skillsStoreSortTrending": "Trending",
