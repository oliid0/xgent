...
/**
 * xgent-chat theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { xgentChatTheme } from './xgent-chat';
 *   import './xgent-chat.css';
 */
export const xgentChatTheme = {
  name: 'xgent-chat',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #212121)",
    "--color-background-body": "light-dark(#f7f7f8, #171717)",
    "--color-background-card": "light-dark(#ffffff, #2f2f2f)",
    "--color-background-popover": "light-dark(#ffffff, #2f2f2f)",
    "--color-background-muted": "light-dark(#f3f3f3, #2f2f2f)",
    "--color-accent": "light-dark(#262626, #ebebeb)",
    "--color-accent-muted": "light-dark(#f1f1f1, #262626)",
    "--color-neutral": "light-dark(#0000000d, #ffffff1a)",
    ...
    "--color-text-secondary": "light-dark(#5d5d5d, #b4b4b4)",
    ...
    "--color-icon-primary": "light-dark(#0d0d0d, #ececec)",
    "--color-icon-secondary": "light-dark(#6b6b6b, #b4b4b4)",
    ...
    "--color-border-emphasized": "light-dark(#d9d9d9, #4a4a4a)",
    ...
    "--radius-page": "24px",
    "--radius-full": "9999px",
    "--shadow-low": "0 1px 2px light-dark(rgb(0 0 0 / 5%), rgb(0 0 0 / 22%)), 0 4px 12px light-dark(rgb(0 0 0 / 6%), rgb(0 0 0 / 30%))",
    "--shadow-med": "0 2px 6px light-dark(rgb(0 0 0 / 7%), rgb(0 0 0 / 28%)), 0 10px 28px light-dark(rgb(0 0 0 / 9%), rgb(0 0 0 / 42%))",
    "--shadow-high": "0 8px 24px light-dark(rgb(0 0 0 / 10%), rgb(0 0 0 / 38%)), 0 24px 64px light-dark(rgb(0 0 0 / 10%), rgb(0 0 0 / 55%))",
