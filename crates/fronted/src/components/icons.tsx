...
function createIcon(Source: IconSource | IconName): IconComponent {
...
export const ArrowLeft = createIcon("chevronLeft");
export const Activity = createIcon(ActivitySource);
export const AtSign = createIcon(AtSignSource);
...
export const Square = createIcon("stop");
