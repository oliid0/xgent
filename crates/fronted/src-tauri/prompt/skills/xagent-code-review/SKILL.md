...
This is an independent Xgent workflow modeled on Anthropic's public Claude Code Code Review plugin. The instructions and implementation are original to Xgent and are not affiliated with or endorsed by Anthropic.
