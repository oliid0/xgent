...
enum InputSimulation {
    ...
    static func dragTargeted(from start: CGPoint, to end: CGPoint, pid: pid_t) throws {
        ...
        let button = actionMouseButton
        var last = start
        try postMouseEventToPid(type: .mouseMoved, source: source, point: start, button: button.cgButton, clickState: 1, pid: pid)
        try postMouseEventToPid(type: button.downEvent, source: source, point: start, button: button.cgButton, clickState: 1, pid: pid)
        defer { try? postMouseEventToPid(type: button.upEvent, source: source, point: last, button: button.cgButton, clickState: 1, pid: pid) }
        ...
        for step in 1...10 {
            ...
            last = point
            try postMouseEventToPid(type: button.dragEvent, source: source, point: point, button: button.cgButton, clickState: 1, pid: pid)
        }
    ...
    static func dragGlobally(from start: CGPoint, to end: CGPoint) throws {
        ...
        let button = actionMouseButton
        var last = start
        try postMouseEvent(type: .mouseMoved, source: source, point: start, button: button.cgButton, clickState: 1)
        try postMouseEvent(type: button.downEvent, source: source, point: start, button: button.cgButton, clickState: 1)
        defer { try? postMouseEvent(type: button.upEvent, source: source, point: last, button: button.cgButton, clickState: 1) }
        ...
        for step in 1...10 {
            ...
            last = point
            try postMouseEvent(type: button.dragEvent, source: source, point: point, button: button.cgButton, clickState: 1)
        }
