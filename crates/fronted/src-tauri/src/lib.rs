...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::settings::settings_backup_cache_skills,
...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::mobile_git::mobile_git_status,
            commands::mobile_git::mobile_git_identity,
            commands::mobile_git::mobile_git_history,
            commands::mobile_git::mobile_git_diff,
            commands::mobile_git::mobile_git_commit_detail,
            commands::mobile_git::mobile_git_mutate,
            commands::mobile_git::mobile_git_remote,
            commands::app::app_runtime_platform,
